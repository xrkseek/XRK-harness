...
| 用途 | 命令 |
|------|------|
| 正式 | `npm i -g @xrkseek/harness-cli@0.1.25` 后 `xrkh web`，或 `npm i -g @xrkseek/harness-cli@latest` |
...
| Line | Version | Notes |
|------|---------|-------|
| **Formal** | [v0.1.25](./v0.1.25.md) | Current recommended install (GitHub Release after publish) |
...
Previous formal: [v0.1.24](./v0.1.24.md).
...
| Use | Command |
|-----|---------|
| Formal | `npm i -g @xrkseek/harness-cli@0.1.25` then `xrkh web`, or `npm i -g @xrkseek/harness-cli@latest` |
