...
| 档 | 版本 | 说明 |
|------|------|------|
| **正式** | [v0.1.26](./v0.1.26.md) | 当前推荐安装（发版后挂 GitHub Release） |
...
| 用途 | 命令 |
|------|------|
| 正式 | `npm i -g @xrkseek/harness-cli@0.1.26` 后 `xrkh web`，或 `npm i -g @xrkseek/harness-cli@latest` |
...
| Line | Version | Notes |
|------|---------|-------|
| **Formal** | [v0.1.26](./v0.1.26.md) | Current recommended install (GitHub Release after publish) |
...
| Use | Command |
|-----|---------|
| Formal | `npm i -g @xrkseek/harness-cli@0.1.26` then `xrkh web`, or `npm i -g @xrkseek/harness-cli@latest` |
