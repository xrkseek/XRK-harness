...
|------|------|------|
| **正式 / Formal** | [v0.1.9](./v0.1.9.md) · [GitHub Release](https://github.com/xrkseek/XRK-harness/releases/tag/v0.1.9) | 当前推荐安装 / Current recommended install |
...
上一正式版 / Previous formal: [v0.1.8](./v0.1.8.md)。
...
| 用途 / Use | 命令 / Command |
|------|------|
| 正式 / Formal | `npx @xrkseek/harness-cli@0.1.9 web` 或 `npm i -g @xrkseek/harness-cli@latest` |
