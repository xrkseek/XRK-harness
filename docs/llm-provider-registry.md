...
| volatile **不进 system**                          | 时钟与 session id 折叠进当前 user 消息的尾缀，**不单独成一条 user 消息**                                                                                                         |
