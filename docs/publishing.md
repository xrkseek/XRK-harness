...
5. Do not publish incomplete packages as complete (MCP HTTP still lacks process supervisor; browser settings-shell E2E is Host-serve only — see [status.md](./status.md)).
