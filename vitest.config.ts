...
export default defineConfig({
  resolve: {
    alias: Object.fromEntries([
      ...
      pkg("a2a", "packages/a2a/src/index.ts"),
      ["@xrkseek/core-session/invariant", path.join(root, "packages/core/session/src/invariant.ts")],
      ...
      ["@xrkseek/core-agent-loop/invariant", path.join(root, "packages/core/agent-loop/src/invariant.ts")],
      pkg("core-agent-loop", "packages/core/agent-loop/src/index.ts"),
      pkg("core-agent", "packages/core/agent/src/index.ts"),
      pkg("runtime-invariants", "packages/runtime-diagnostics/invariants/src/index.ts"),
      ...
      pkg("exec-voice", "packages/exec/voice/src/index.ts"),
      ["@xrkseek/secrets/redact", path.join(root, "packages/util/secrets/src/redact.ts")],
      pkg("secrets", "packages/util/secrets/src/index.ts"),
      pkg("exec-environment", "packages/exec/environment/src/index.ts"),
      ...
      pkg("attachment-local", "packages/attachment-local/src/index.ts"),
      ...
      pkg("client-ui-primitives", "packages/client/ui-primitives/src/index.ts"),
