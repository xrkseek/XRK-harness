...
import LocalSubprocessRuntime from '@xrkseek/xrk-subprocess-local'
import type { SubprocessHandle, SubprocessSpawnSpec } from '@xrkseek/xrk-subprocess'
...
it('hot-reloads a real client-plugin source edit without refreshing the page', async () => {
  ...
  const oldText = 'Local agents, your harness'
  const sourceNeedle = "'hero.headline': 'Local agents, your harness'"
