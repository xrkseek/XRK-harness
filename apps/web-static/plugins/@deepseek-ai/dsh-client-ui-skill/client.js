window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-skill\src\client\SkillRow.module.css.mjs
		const css = ".qvyKmq_card{flex-direction:column;display:flex}.qvyKmq_row{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.qvyKmq_row[data-expandable]{cursor:pointer}.qvyKmq_card[data-state=running] .qvyKmq_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite qvyKmq_dsh-skill-row-sweep;position:absolute;inset:0 auto 0 0}@keyframes qvyKmq_dsh-skill-row-sweep{0%{left:-300px}90%,to{left:100%}}.qvyKmq_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.qvyKmq_chevron{color:var(--dsw-alias-label-secondary)}.qvyKmq_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.qvyKmq_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.qvyKmq_row:hover .qvyKmq_iconIdle{opacity:0}.qvyKmq_row:hover .qvyKmq_chevronHover{opacity:1}.qvyKmq_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.qvyKmq_separator{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.qvyKmq_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.qvyKmq_errorSummary{color:var(--dsw-alias-state-error-primary)}.qvyKmq_bodyWrap{flex-direction:column;display:flex}.qvyKmq_instructionsCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);border-radius:12px;flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:hidden}.qvyKmq_instructionsHeader{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block-banner);color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:8px 12px;font-size:11px;font-weight:500;line-height:16px}.qvyKmq_instructions{white-space:pre-wrap;overflow-wrap:anywhere;min-height:0;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);margin:0;padding:10px 12px 12px;overflow:auto}.qvyKmq_instructions[data-error]{color:var(--dsw-alias-state-error-primary)}.qvyKmq_instructions::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.qvyKmq_instructions::-webkit-scrollbar-track{margin:6px 0}.qvyKmq_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.qvyKmq_card:hover .qvyKmq_inspectButton,.qvyKmq_inspectButton:focus-visible{opacity:1}.qvyKmq_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.qvyKmq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.qvyKmq_card[data-state=running] .qvyKmq_row:after{animation:none;display:none}.qvyKmq_iconIdle,.qvyKmq_chevronHover,.qvyKmq_inspectButton{transition:none}}";
		...
		var SkillRow_module_css_default = {
			"card": "qvyKmq_card",
			"errorSummary": "qvyKmq_errorSummary",
			"inspectButton": "qvyKmq_inspectButton",
			"iconIdle": "qvyKmq_iconIdle",
			"row": "qvyKmq_row",
			"dsh-skill-row-sweep": "qvyKmq_dsh-skill-row-sweep",
			"separator": "qvyKmq_separator",
			"instructionsHeader": "qvyKmq_instructionsHeader",
			"leading": "qvyKmq_leading",
			"instructions": "qvyKmq_instructions",
			"instructionsCard": "qvyKmq_instructionsCard",
			"title": "qvyKmq_title",
			"chevron": "qvyKmq_chevron",
			"visuallyHidden": "qvyKmq_visuallyHidden",
			"chevronHover": "qvyKmq_chevronHover",
			"summary": "qvyKmq_summary",
			"bodyWrap": "qvyKmq_bodyWrap"
		};
		//#endregion
