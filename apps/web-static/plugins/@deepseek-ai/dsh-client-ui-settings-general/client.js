window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-settings-general\src\client\SettingsRoot.module.css.mjs
		const css$3 = ".RgbhAq_trigger{box-sizing:border-box;cursor:pointer;width:calc(100% + 8px);height:34px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:12px;flex:none;align-items:center;gap:8px;margin:4px -4px;padding:6px 2px 6px 10px;font-family:inherit;font-size:14px;line-height:22px;display:flex;overflow:hidden}.RgbhAq_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}.RgbhAq_trigger.RgbhAq_rail{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;margin:8px 0 10px;padding:0}.RgbhAq_triggerLabel{white-space:nowrap;overflow:hidden}.RgbhAq_overlay{z-index:1000;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}.RgbhAq_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.RgbhAq_panel{z-index:1;background:var(--dsw-alias-bg-layer-2);width:800px;max-width:calc(100vw - 48px);height:min(800px,100vh - 48px);box-shadow:var(--dsw-shadow-lv3);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:24px;display:flex;position:relative;overflow:hidden}.RgbhAq_nav{box-sizing:border-box;flex-direction:column;flex:none;gap:18px;width:188px;padding:22px 12px 0;display:flex}.RgbhAq_navTitle{color:var(--dsw-alias-label-primary);padding:0 12px;font-size:16px;font-weight:500;line-height:24px}.RgbhAq_navList{flex-direction:column;gap:4px;display:flex}.RgbhAq_navCell{box-sizing:border-box;cursor:pointer;height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:9px 16px 9px 12px;font-family:inherit;font-size:14px;font-weight:400;line-height:22px;display:flex}.RgbhAq_navCell:hover{background:var(--dsw-specific-sidebar-nav-item-hover)}.RgbhAq_navCell.RgbhAq_active{background:var(--dsw-specific-sidebar-nav-item-active)}.RgbhAq_navIcon{flex:none}.RgbhAq_navLabel{white-space:nowrap;text-overflow:ellipsis;flex:1;min-width:0;overflow:hidden}.RgbhAq_content{flex-direction:column;flex:1;min-width:0;display:flex}.RgbhAq_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:flex-start;gap:8px;height:54px;padding:20px 14px 8px 10px;display:flex}.RgbhAq_actions{justify-content:flex-end;align-items:center;gap:8px;min-width:0;margin-left:auto;display:flex}.RgbhAq_close{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:0;display:inline-flex}.RgbhAq_close:hover{background:var(--dsw-alias-interactive-bg-hover)}.RgbhAq_options{flex:1;min-height:0;padding:0 24px 24px;overflow-y:auto}.RgbhAq_hiddenLabel{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var SettingsRoot_module_css_default = {
			"navTitle": "RgbhAq_navTitle",
			"navList": "RgbhAq_navList",
			"rail": "RgbhAq_rail",
			"header": "RgbhAq_header",
			"close": "RgbhAq_close",
			"hiddenLabel": "RgbhAq_hiddenLabel",
			"mask": "RgbhAq_mask",
			"navIcon": "RgbhAq_navIcon",
			"actions": "RgbhAq_actions",
			"nav": "RgbhAq_nav",
			"panel": "RgbhAq_panel",
			"navLabel": "RgbhAq_navLabel",
			"content": "RgbhAq_content",
			"options": "RgbhAq_options",
			"active": "RgbhAq_active",
			"triggerLabel": "RgbhAq_triggerLabel",
			"overlay": "RgbhAq_overlay",
			"navCell": "RgbhAq_navCell",
			"trigger": "RgbhAq_trigger"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-settings-general\src\client\chrome.module.css.mjs
		const css$2 = ".Sekv1a_triggerLabel{white-space:nowrap;overflow:hidden}";
		...
		var chrome_module_css_default = { "triggerLabel": "Sekv1a_triggerLabel" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-settings-general\src\client\GeneralSection.module.css.mjs
		const css$1 = ".Aib5Ia_section{flex-direction:column;width:100%;display:flex}.Aib5Ia_section>[data-slot=\"settings.general.item\"]>:last-child{border-bottom:none}";
		...
		var GeneralSection_module_css_default = { "section": "Aib5Ia_section" };
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-settings-general\src\client\SettingsDocumentAction.module.css.mjs
		const css = ".I9KrMW_action{align-items:center;gap:8px;min-width:0;display:flex}.I9KrMW_error{max-width:180px;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}";
