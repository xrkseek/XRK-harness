window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-subagent\src\client\SubagentCatalogAction.module.css.mjs
		const css$1 = "._4dOx9q_root{position:relative}._4dOx9q_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}._4dOx9q_count{margin:0 5px}._4dOx9q_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}._4dOx9q_trigger:hover,._4dOx9q_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}._4dOx9q_trigger svg{transition:transform .12s}._4dOx9q_triggerOpen{transform:rotate(180deg)}._4dOx9q_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}._4dOx9q_node{min-width:0;position:relative}._4dOx9q_menu>._4dOx9q_node{margin-left:-3px}._4dOx9q_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}._4dOx9q_row:hover>._4dOx9q_clickarea,._4dOx9q_row:focus-visible>._4dOx9q_clickarea{background:var(--dsw-alias-interactive-bg-hover)}._4dOx9q_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}._4dOx9q_row>[data-state],._4dOx9q_clickarea>[data-state]{margin-top:4px}._4dOx9q_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}._4dOx9q_disabled:hover{background:0 0}._4dOx9q_loadingRow{cursor:default}._4dOx9q_disclosure,._4dOx9q_disclosureSpace{flex:none;width:14px;height:18px}._4dOx9q_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}._4dOx9q_disclosure:hover{color:var(--dsw-alias-label-primary)}._4dOx9q_disclosureOpen{transform:rotate(90deg)}._4dOx9q_content{flex-direction:column;flex:1;min-width:0;display:flex}._4dOx9q_label,._4dOx9q_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._4dOx9q_label{color:inherit;font-weight:400}._4dOx9q_summary,._4dOx9q_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}._4dOx9q_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex:none;grid-template-rows:18px 16px;display:grid}._4dOx9q_metricToken{grid-row:1;line-height:18px}._4dOx9q_metricDuration{grid-row:2}._4dOx9q_children{margin-left:18px;padding-left:4px;position:relative}._4dOx9q_children:before,._4dOx9q_children>._4dOx9q_node:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;left:0}._4dOx9q_children:before{height:26px;top:-26px}._4dOx9q_children[aria-busy=true]:before{content:none}._4dOx9q_children>._4dOx9q_node:before{top:0;bottom:0;left:-4px}._4dOx9q_children>._4dOx9q_node:last-child:before{height:17px;bottom:auto}._4dOx9q_children>._4dOx9q_node>._4dOx9q_row:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}._4dOx9q_notice,._4dOx9q_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}._4dOx9q_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}._4dOx9q_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}._4dOx9q_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentCatalogAction_module_css_default = {
			"refresh": "_4dOx9q_refresh",
			"clickarea": "_4dOx9q_clickarea",
			"disclosureOpen": "_4dOx9q_disclosureOpen",
			"metricToken": "_4dOx9q_metricToken",
			"root": "_4dOx9q_root",
			"notice": "_4dOx9q_notice",
			"error": "_4dOx9q_error",
			"metricDuration": "_4dOx9q_metricDuration",
			"menu": "_4dOx9q_menu",
			"disabled": "_4dOx9q_disabled",
			"node": "_4dOx9q_node",
			"count": "_4dOx9q_count",
			"row": "_4dOx9q_row",
			"disclosure": "_4dOx9q_disclosure",
			"disclosureSpace": "_4dOx9q_disclosureSpace",
			"label": "_4dOx9q_label",
			"activitySlot": "_4dOx9q_activitySlot",
			"loadingRow": "_4dOx9q_loadingRow",
			"summary": "_4dOx9q_summary",
			"trigger": "_4dOx9q_trigger",
			"triggerOpen": "_4dOx9q_triggerOpen",
			"content": "_4dOx9q_content",
			"metrics": "_4dOx9q_metrics",
			"children": "_4dOx9q_children"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-subagent\src\client\SubagentReadOnlyComposer.module.css.mjs
		const css = ".GiKu2q_frame{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-height:54px;color:var(--dsw-alias-label-tertiary);border-radius:14px;justify-content:center;align-items:center;gap:8px;margin:0 24px 20px;padding:10px 16px;font-size:13px;line-height:20px;display:flex}.GiKu2q_frame strong{color:var(--dsw-alias-label-primary);font-weight:510}";
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "GiKu2q_frame" };
		//#endregion
