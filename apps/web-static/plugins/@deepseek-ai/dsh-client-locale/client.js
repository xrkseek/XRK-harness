window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\locale\src\client\LanguageRow.module.css.mjs
		const css = ".BOL7tq_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.BOL7tq_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.BOL7tq_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.BOL7tq_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.BOL7tq_selector:hover{background:var(--dsw-alias-interactive-bg-hover)}.BOL7tq_chevron{flex:none}";
		...
		var LanguageRow_module_css_default = {
			"rowText": "BOL7tq_rowText",
			"row": "BOL7tq_row",
			"selector": "BOL7tq_selector",
			"title": "BOL7tq_title",
			"chevron": "BOL7tq_chevron"
		};
		//#endregion
