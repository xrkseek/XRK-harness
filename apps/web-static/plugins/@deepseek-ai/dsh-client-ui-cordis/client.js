window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisRunRow.module.css.mjs
		const css$2 = "._2zz3ua_card{flex-direction:column;gap:8px;display:flex}._2zz3ua_row{align-items:center;min-height:32px;display:flex}._2zz3ua_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}._2zz3ua_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}._2zz3ua_separator{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}._2zz3ua_summary,._2zz3ua_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}._2zz3ua_error{color:var(--dsw-alias-state-error-primary)}._2zz3ua_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}._2zz3ua_card[data-cordis-status=awaiting-approval] ._2zz3ua_status,._2zz3ua_card[data-cordis-status=client-pending] ._2zz3ua_status{color:var(--dsw-alias-state-warn-label)}._2zz3ua_card[data-cordis-status=running] ._2zz3ua_status{color:var(--dsw-alias-state-success-primary)}._2zz3ua_card[data-cordis-status=failed] ._2zz3ua_status{color:var(--dsw-alias-state-error-primary)}._2zz3ua_inspect{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}._2zz3ua_card:hover ._2zz3ua_inspect,._2zz3ua_inspect:focus-visible{opacity:1}._2zz3ua_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}._2zz3ua_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}._2zz3ua_business{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}._2zz3ua_output{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}._2zz3ua_business ._2zz3ua_output{border:none;border-radius:0}";
		...
		var CordisRunRow_module_css_default = {
			"inspect": "_2zz3ua_inspect",
			"output": "_2zz3ua_output",
			"error": "_2zz3ua_error",
			"title": "_2zz3ua_title",
			"row": "_2zz3ua_row",
			"summary": "_2zz3ua_summary",
			"message": "_2zz3ua_message",
			"card": "_2zz3ua_card",
			"business": "_2zz3ua_business",
			"icon": "_2zz3ua_icon",
			"separator": "_2zz3ua_separator",
			"status": "_2zz3ua_status"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisDefineRow.module.css.mjs
		const css$1 = ".sUMCxq_card{flex-direction:column;display:flex}.sUMCxq_card .sUMCxq_title,.sUMCxq_card .sUMCxq_chevron{color:var(--dsw-alias-state-business-primary)}.sUMCxq_title{flex:none;font-size:14px;font-weight:500;line-height:24px}.sUMCxq_row{gap:0}.sUMCxq_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.sUMCxq_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}.sUMCxq_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}.sUMCxq_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.sUMCxq_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.sUMCxq_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}.sUMCxq_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}.sUMCxq_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}.sUMCxq_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.sUMCxq_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.sUMCxq_switch{height:22px;padding:0 8px;font-size:12px}.sUMCxq_card[data-terminal] .sUMCxq_title,.sUMCxq_card[data-terminal] .sUMCxq_name,.sUMCxq_card[data-terminal] .sUMCxq_purpose,.sUMCxq_card[data-terminal] .sUMCxq_statusLabel{color:var(--dsw-alias-label-caption)}.sUMCxq_card[data-terminal] .sUMCxq_separator{background:var(--dsw-alias-label-caption)}.sUMCxq_bodyWrap{flex-direction:column;display:flex}.sUMCxq_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}.sUMCxq_sourceTabs{border-bottom:1px solid var(--dsw-alias-border-l2);height:32px;display:flex}.sUMCxq_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}.sUMCxq_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.sUMCxq_sourceTab:disabled{cursor:default;opacity:.4}.sUMCxq_sourceTabActive{color:var(--dsw-alias-state-business-primary)}.sUMCxq_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}.sUMCxq_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.sUMCxq_sourcePanel{max-height:260px;overflow:auto}.sUMCxq_sourceCode{margin:0}.sUMCxq_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}.sUMCxq_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}.sUMCxq_output{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}.sUMCxq_output[data-error]{color:var(--dsw-alias-state-error-primary)}.sUMCxq_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.sUMCxq_card:hover .sUMCxq_inspectButton,.sUMCxq_inspectButton:focus-visible{opacity:1}.sUMCxq_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.sUMCxq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.sUMCxq_inspectButton{transition:none}}";
		...
		var CordisDefineRow_module_css_default = {
			"card": "sUMCxq_card",
			"errorSummary": "sUMCxq_errorSummary",
			"statusLabel": "sUMCxq_statusLabel",
			"sourceTab": "sUMCxq_sourceTab",
			"output": "sUMCxq_output",
			"readout": "sUMCxq_readout",
			"sourceCode": "sUMCxq_sourceCode",
			"sourcePanel": "sUMCxq_sourcePanel",
			"approvalPrompt": "sUMCxq_approvalPrompt",
			"sectionLabel": "sUMCxq_sectionLabel",
			"title": "sUMCxq_title",
			"name": "sUMCxq_name",
			"sourceTabs": "sUMCxq_sourceTabs",
			"separator": "sUMCxq_separator",
			"notice": "sUMCxq_notice",
			"codeSection": "sUMCxq_codeSection",
			"visuallyHidden": "sUMCxq_visuallyHidden",
			"switch": "sUMCxq_switch",
			"panelHint": "sUMCxq_panelHint",
			"sourceCard": "sUMCxq_sourceCard",
			"requestError": "sUMCxq_requestError",
			"sourceTabActive": "sUMCxq_sourceTabActive",
			"row": "sUMCxq_row",
			"chevron": "sUMCxq_chevron",
			"inspectButton": "sUMCxq_inspectButton",
			"purpose": "sUMCxq_purpose",
			"bodyWrap": "sUMCxq_bodyWrap"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisPanel.module.css.mjs
		const css = ".NpNKUa_layer{flex:none;align-items:center;width:100%;height:49px;margin:8px 0 0;display:flex;position:relative}.NpNKUa_footerButtons{align-items:center;width:100%;display:flex}.NpNKUa_badge{width:100%;height:49px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:0 8px 0 6px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.NpNKUa_badge:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.NpNKUa_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.NpNKUa_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.NpNKUa_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.NpNKUa_layer.NpNKUa_rail{width:36px;height:36px;margin:0}.NpNKUa_rail .NpNKUa_badge{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.NpNKUa_rail .NpNKUa_footerButtons{flex-direction:column;gap:2px}.NpNKUa_panel{z-index:30;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-shadow-lv2);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;display:flex;position:fixed;bottom:128px;left:12px;overflow:hidden}.NpNKUa_header{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.NpNKUa_body{flex:1;min-height:0;padding:4px 12px 12px;overflow-y:auto}.NpNKUa_title{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:500;line-height:20px}.NpNKUa_note,.NpNKUa_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.NpNKUa_readError{color:var(--dsw-alias-state-error-primary)}.NpNKUa_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0 4px;font-size:11px;font-weight:500;line-height:16px}.NpNKUa_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.NpNKUa_row{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;flex-direction:column;gap:8px;padding:10px 12px;display:flex}.NpNKUa_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.NpNKUa_rowHead{align-items:center;gap:8px;display:flex}.NpNKUa_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.NpNKUa_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.NpNKUa_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.NpNKUa_row[data-cordis-status=idle] .NpNKUa_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.NpNKUa_row[data-cordis-status=awaiting-approval] .NpNKUa_rowStatus,.NpNKUa_row[data-cordis-status=client-pending] .NpNKUa_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.NpNKUa_row[data-cordis-status=failed] .NpNKUa_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.NpNKUa_row[data-cordis-status=running] .NpNKUa_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.NpNKUa_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.NpNKUa_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.NpNKUa_versionPicker select{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;border-radius:7px;flex:1;padding:0 8px}.NpNKUa_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.NpNKUa_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.NpNKUa_rowActions{flex:none;align-items:center;gap:10px;display:flex}.NpNKUa_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.NpNKUa_transitionActions{gap:6px;margin-left:auto;display:flex}.NpNKUa_transitionActions button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.NpNKUa_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.NpNKUa_transitionActions button:disabled{opacity:.4;cursor:default}.NpNKUa_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.NpNKUa_actionButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.NpNKUa_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.NpNKUa_actionButton:disabled{opacity:.4;cursor:default}.NpNKUa_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.NpNKUa_doubleCheck svg{position:absolute;top:1px}.NpNKUa_doubleCheck svg:first-child{opacity:.7;left:0}.NpNKUa_doubleCheck svg:last-child{left:5px}";
		...
		var CordisPanel_module_css_default = {
			"rowPurpose": "NpNKUa_rowPurpose",
			"rowActions": "NpNKUa_rowActions",
			"rows": "NpNKUa_rows",
			"activeVersion": "NpNKUa_activeVersion",
			"group": "NpNKUa_group",
			"transitionActions": "NpNKUa_transitionActions",
			"actionButton": "NpNKUa_actionButton",
			"title": "NpNKUa_title",
			"rowHead": "NpNKUa_rowHead",
			"badgeCount": "NpNKUa_badgeCount",
			"doubleCheck": "NpNKUa_doubleCheck",
			"readError": "NpNKUa_readError",
			"transition": "NpNKUa_transition",
			"badgeLabel": "NpNKUa_badgeLabel",
			"panel": "NpNKUa_panel",
			"rowId": "NpNKUa_rowId",
			"note": "NpNKUa_note",
			"rowStatus": "NpNKUa_rowStatus",
			"rowDetail": "NpNKUa_rowDetail",
			"rowError": "NpNKUa_rowError",
			"header": "NpNKUa_header",
			"versionPicker": "NpNKUa_versionPicker",
			"rail": "NpNKUa_rail",
			"badge": "NpNKUa_badge",
			"row": "NpNKUa_row",
			"rowName": "NpNKUa_rowName",
			"layer": "NpNKUa_layer",
			"footerButtons": "NpNKUa_footerButtons",
			"body": "NpNKUa_body"
		};
		//#endregion
