window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-workflow-run\src\client\WorkflowRunPanel.module.css.mjs
		const css = "._9fF5Vq_root{width:100%;min-width:0}._9fF5Vq_runHeader{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);border-radius:8px;align-items:center;gap:6px;width:100%;min-width:0;height:32px;padding:0 8px;display:flex}._9fF5Vq_runHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}._9fF5Vq_runLeading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}._9fF5Vq_runTitle{max-width:42%;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:14px;font-weight:510;line-height:24px;overflow:hidden}._9fF5Vq_runSummary{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}._9fF5Vq_statusTail{height:20px;color:var(--dsw-alias-label-secondary);white-space:nowrap;flex:none;align-items:center;gap:4px;font-size:11px;font-weight:510;line-height:16px;display:inline-flex;overflow:hidden}._9fF5Vq_phaseHeader{box-sizing:border-box;align-items:center;gap:6px;width:100%;min-width:0;height:32px;display:flex}._9fF5Vq_phaseHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px;border-radius:4px}._9fF5Vq_phaseLeading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}._9fF5Vq_phaseTitle{min-width:0;max-width:42%;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;font-size:14px;line-height:24px;overflow:hidden}._9fF5Vq_phaseCount{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:20px;overflow:hidden}._9fF5Vq_phaseStatus{width:132px;color:var(--dsw-alias-label-secondary);text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:13px;line-height:20px;overflow:hidden}._9fF5Vq_separator{background:var(--dsw-alias-label-tertiary);border-radius:50%;flex:none;width:2px;height:2px}._9fF5Vq_phaseList{flex-direction:column;gap:4px;min-width:0;padding:4px 0 0 16px;display:flex}._9fF5Vq_phase{min-width:0}._9fF5Vq_members{flex-direction:column;gap:2px;min-width:0;padding:0 0 0 16px;display:flex}._9fF5Vq_memberRow,._9fF5Vq_memberButton{width:100%;min-width:0;min-height:24px;color:var(--dsw-alias-label-secondary);font:inherit;text-align:left;background:0 0;border:0;border-radius:4px;align-items:center;gap:12px;padding:0;display:flex}._9fF5Vq_memberButton{cursor:pointer}._9fF5Vq_memberButton ._9fF5Vq_memberLabel{color:var(--dsw-alias-state-business-primary);text-underline-position:from-font;text-decoration:underline}._9fF5Vq_dotSlot{flex:none;justify-content:center;align-items:center;width:16px;height:24px;display:inline-flex;overflow:hidden}._9fF5Vq_memberButton:focus-visible{outline:none}._9fF5Vq_memberButton:focus-visible ._9fF5Vq_memberLabelWrap{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._9fF5Vq_memberLabelWrap{border-radius:4px;flex:1;align-items:center;min-width:0;height:24px;padding:0 2px;display:flex;overflow:hidden}._9fF5Vq_memberLabel{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:14px;line-height:24px;overflow:hidden}._9fF5Vq_memberStatus{width:64px;color:var(--dsw-alias-label-secondary);text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:13px;line-height:20px;overflow:hidden}._9fF5Vq_empty{color:var(--dsw-alias-label-tertiary);padding:0;font-size:13px;line-height:20px}@media (width<=560px){._9fF5Vq_phaseList,._9fF5Vq_members{padding-left:12px}}";
		...
		var WorkflowRunPanel_module_css_default = {
			"phaseTitle": "_9fF5Vq_phaseTitle",
			"phaseStatus": "_9fF5Vq_phaseStatus",
			"memberRow": "_9fF5Vq_memberRow",
			"memberLabel": "_9fF5Vq_memberLabel",
			"memberLabelWrap": "_9fF5Vq_memberLabelWrap",
			"dotSlot": "_9fF5Vq_dotSlot",
			"memberStatus": "_9fF5Vq_memberStatus",
			"separator": "_9fF5Vq_separator",
			"phaseList": "_9fF5Vq_phaseList",
			"root": "_9fF5Vq_root",
			"runTitle": "_9fF5Vq_runTitle",
			"empty": "_9fF5Vq_empty",
			"runSummary": "_9fF5Vq_runSummary",
			"phase": "_9fF5Vq_phase",
			"statusTail": "_9fF5Vq_statusTail",
			"runHeader": "_9fF5Vq_runHeader",
			"phaseLeading": "_9fF5Vq_phaseLeading",
			"phaseCount": "_9fF5Vq_phaseCount",
			"phaseHeader": "_9fF5Vq_phaseHeader",
			"members": "_9fF5Vq_members",
			"memberButton": "_9fF5Vq_memberButton",
			"runLeading": "_9fF5Vq_runLeading"
		};
		//#endregion
