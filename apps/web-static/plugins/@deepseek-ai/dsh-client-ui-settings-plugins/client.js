window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-settings-plugins\src\client\fields.module.css.mjs
		const css$2 = ".VvRdBq_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}.VvRdBq_field+.VvRdBq_field{border-top:1px solid var(--dsw-alias-border-l2)}.VvRdBq_head{align-items:center;gap:8px;display:flex}.VvRdBq_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}.VvRdBq_badges{align-items:center;gap:8px;display:inline-flex}.VvRdBq_badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.VvRdBq_badgeMuted{white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}.VvRdBq_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}.VvRdBq_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.VvRdBq_reset:disabled{cursor:default}.VvRdBq_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.VvRdBq_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.VvRdBq_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.VvRdBq_inputInvalid{border-color:var(--dsw-alias-label-error);}.VvRdBq_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}.VvRdBq_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			"badgeMuted": "VvRdBq_badgeMuted",
			"badges": "VvRdBq_badges",
			"reset": "VvRdBq_reset",
			"field": "VvRdBq_field",
			"badge": "VvRdBq_badge",
			"label": "VvRdBq_label",
			"hint": "VvRdBq_hint",
			"invalid": "VvRdBq_invalid",
			"input": "VvRdBq_input",
			"head": "VvRdBq_head",
			"inputInvalid": "VvRdBq_inputInvalid"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-settings-plugins\src\client\PluginCard.module.css.mjs
		const css$1 = "._2BBQja_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}._2BBQja_card:hover{border-color:var(--dsw-alias-label-dimmed)}._2BBQja_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}._2BBQja_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}._2BBQja_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}._2BBQja_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}._2BBQja_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}._2BBQja_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}._2BBQja_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}._2BBQja_chevronOpen{transform:rotate(180deg)}._2BBQja_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}._2BBQja_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}._2BBQja_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}._2BBQja_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}._2BBQja_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}._2BBQja_discard,._2BBQja_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}._2BBQja_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}._2BBQja_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}._2BBQja_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}._2BBQja_discard:disabled,._2BBQja_save:disabled{opacity:.4;cursor:default}._2BBQja_discard:focus-visible,._2BBQja_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"readOnly": "_2BBQja_readOnly",
			"body": "_2BBQja_body",
			"chevronOpen": "_2BBQja_chevronOpen",
			"card": "_2BBQja_card",
			"description": "_2BBQja_description",
			"name": "_2BBQja_name",
			"discard": "_2BBQja_discard",
			"chevron": "_2BBQja_chevron",
			"footer": "_2BBQja_footer",
			"cardOpen": "_2BBQja_cardOpen",
			"pending": "_2BBQja_pending",
			"save": "_2BBQja_save",
			"headText": "_2BBQja_headText",
			"header": "_2BBQja_header",
			"failed": "_2BBQja_failed"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-settings-plugins\src\client\PluginsSettingsSection.module.css.mjs
		const css = "._0qJrVq_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}._0qJrVq_heading{margin:0;font-size:18px;font-weight:600}._0qJrVq_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}._0qJrVq_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}._0qJrVq_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}._0qJrVq_tab:hover,._0qJrVq_tab[data-active=true]{color:var(--dsw-alias-label-primary)}._0qJrVq_tab[data-active=true]:after,._0qJrVq_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}._0qJrVq_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}._0qJrVq_panel{min-width:0;padding-top:2px}._0qJrVq_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}._0qJrVq_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			"section": "_0qJrVq_section",
			"heading": "_0qJrVq_heading",
			"tab": "_0qJrVq_tab",
			"panel": "_0qJrVq_panel",
			"tabs": "_0qJrVq_tabs",
			"empty": "_0qJrVq_empty",
		...
		*/
		...
		const en = {
			...
			webSearchDescription: "Web search provider for this deployment.",
		...
		const zh = {
			...
			webSearchTitle: "网页搜索",
			webSearchDescription: "本部署的网页搜索提供方。",
			webSearchApiKey: "API Key",
