window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-tool\src\client\tool\components\ToolRow.module.css.mjs
		const css$3 = ".WOXw_W_root{flex-direction:column;display:flex}.WOXw_W_row{position:relative;overflow:hidden}.WOXw_W_root[data-state=running] .WOXw_W_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite WOXw_W_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes WOXw_W_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.WOXw_W_leading{flex-shrink:0}.WOXw_W_root[data-tool^=cordis_] .WOXw_W_leading,.WOXw_W_root[data-tool^=cordis_] .WOXw_W_title{color:var(--dsw-alias-state-business-primary)}.WOXw_W_root[data-tool^=cordis_] .WOXw_W_title{font-weight:500}.WOXw_W_root[data-tool^=cordis_] .WOXw_W_sep{background:var(--dsw-alias-state-business-primary)}.WOXw_W_chevron{color:var(--dsw-alias-label-secondary)}.WOXw_W_title{font-weight:400}.WOXw_W_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.WOXw_W_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.WOXw_W_summarySuffix{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px;font-size:14px;line-height:24px}.WOXw_W_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-label-secondary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;font-size:14px;line-height:24px;overflow:hidden}.WOXw_W_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.WOXw_W_errorSummary{color:var(--dsw-alias-state-error-primary)}.WOXw_W_bodyWrap{flex-direction:column;display:flex}.WOXw_W_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.WOXw_W_root:hover .WOXw_W_inspectButton,.WOXw_W_inspectButton:focus-visible{opacity:1}.WOXw_W_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.WOXw_W_bodyScroll{max-height:260px;overflow-y:auto}.WOXw_W_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.WOXw_W_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.WOXw_W_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.WOXw_W_ioSection::-webkit-scrollbar-track{margin:6px 0}.WOXw_W_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.WOXw_W_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.WOXw_W_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.WOXw_W_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.WOXw_W_codeBody,.WOXw_W_terminalBody,.WOXw_W_diffBody,.WOXw_W_readBody,.WOXw_W_searchBody,.WOXw_W_webBody{margin:4px 0 4px 4px}.WOXw_W_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.WOXw_W_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.WOXw_W_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}.WOXw_W_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"webBody": "WOXw_W_webBody",
			"searchRecovery": "WOXw_W_searchRecovery",
			"row": "WOXw_W_row",
			"sep": "WOXw_W_sep",
			"summary": "WOXw_W_summary",
			"ioText": "WOXw_W_ioText",
			"terminalBody": "WOXw_W_terminalBody",
			"readBody": "WOXw_W_readBody",
			"visuallyHidden": "WOXw_W_visuallyHidden",
			"leading": "WOXw_W_leading",
			"dsh-tool-row-sweep": "WOXw_W_dsh-tool-row-sweep",
			"searchBody": "WOXw_W_searchBody",
			"summarySuffix": "WOXw_W_summarySuffix",
			"chevron": "WOXw_W_chevron",
			"title": "WOXw_W_title",
			"bodyScroll": "WOXw_W_bodyScroll",
			"bodyWrap": "WOXw_W_bodyWrap",
			"ioDivider": "WOXw_W_ioDivider",
			"inspectButton": "WOXw_W_inspectButton",
			"fileLink": "WOXw_W_fileLink",
			"errorSummary": "WOXw_W_errorSummary",
			"ioLabel": "WOXw_W_ioLabel",
			"ioCard": "WOXw_W_ioCard",
			"codeBody": "WOXw_W_codeBody",
			"diffBody": "WOXw_W_diffBody",
			"root": "WOXw_W_root",
			"ioSection": "WOXw_W_ioSection"
		};
		//#endregion
		...
		*  summary already describe a settled row). */
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-tool\src\client\tool\ToolCallTree.module.css.mjs
		const css$2 = ".hoI9JG_callRow{border-radius:6px}.hoI9JG_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"subCalls": "hoI9JG_subCalls",
			"callRow": "hoI9JG_callRow"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-tool\src\client\tool\ToolDetails.module.css.mjs
		const css$1 = ".sYkz4a_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.sYkz4a_cardBody{margin:0}.sYkz4a_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.sYkz4a_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.sYkz4a_code[data-error]{color:var(--dsw-alias-state-error-primary)}.sYkz4a_read,.sYkz4a_web{margin:0}.sYkz4a_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			"code": "sYkz4a_code",
			"empty": "sYkz4a_empty",
			"description": "sYkz4a_description",
			"recovery": "sYkz4a_recovery",
			"cardBody": "sYkz4a_cardBody",
			"read": "sYkz4a_read",
			"web": "sYkz4a_web"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-tool\src\client\tool\toolviews\bash-sample.module.css.mjs
		const css = ".XsCa5W_card{flex-direction:column;display:flex}.XsCa5W_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.XsCa5W_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.XsCa5W_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.XsCa5W_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.XsCa5W_ioSection::-webkit-scrollbar-track{margin:6px 0}.XsCa5W_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.XsCa5W_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.XsCa5W_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.XsCa5W_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.XsCa5W_root[data-expandable]{cursor:pointer}.XsCa5W_root{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.XsCa5W_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite XsCa5W_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes XsCa5W_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.XsCa5W_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.XsCa5W_chevron{color:var(--dsw-alias-label-secondary)}.XsCa5W_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.XsCa5W_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.XsCa5W_root:hover .XsCa5W_iconIdle{opacity:0}.XsCa5W_root:hover .XsCa5W_chevronHover{opacity:1}.XsCa5W_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.XsCa5W_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.XsCa5W_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.XsCa5W_errorSummary{color:var(--dsw-alias-state-error-primary)}.XsCa5W_bodyWrap{flex-direction:column;display:flex}.XsCa5W_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.XsCa5W_card:hover .XsCa5W_inspectButton,.XsCa5W_inspectButton:focus-visible{opacity:1}.XsCa5W_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.XsCa5W_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"ioText": "XsCa5W_ioText",
			"ioDivider": "XsCa5W_ioDivider",
			"sep": "XsCa5W_sep",
			"card": "XsCa5W_card",
			"leading": "XsCa5W_leading",
			"ioCard": "XsCa5W_ioCard",
			"root": "XsCa5W_root",
			"summary": "XsCa5W_summary",
			"bodyWrap": "XsCa5W_bodyWrap",
			"errorSummary": "XsCa5W_errorSummary",
			"ioLabel": "XsCa5W_ioLabel",
			"iconIdle": "XsCa5W_iconIdle",
			"dsh-bash-row-sweep": "XsCa5W_dsh-bash-row-sweep",
			"chevronHover": "XsCa5W_chevronHover",
			"inspectButton": "XsCa5W_inspectButton",
			"visuallyHidden": "XsCa5W_visuallyHidden",
			"chevron": "XsCa5W_chevron",
			"terminal": "XsCa5W_terminal",
			"title": "XsCa5W_title",
			"ioSection": "XsCa5W_ioSection"
		};
		//#endregion
