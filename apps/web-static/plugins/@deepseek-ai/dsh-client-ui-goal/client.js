window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-goal\src\client\GoalBar.module.css.mjs
		const css$1 = ".zg1olG_dock{box-sizing:border-box;width:calc(100% - var(--dsh-composer-side-clearance) - var(--dsh-composer-side-clearance) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset));margin:0 auto}.zg1olG_bar{box-sizing:border-box;width:100%;max-width:calc(var(--dsh-composer-card-max-width) - 4 * var(--dsh-composer-dock-inset));border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-specific-tip);border-radius:12px;align-items:center;gap:10px;height:36px;margin:0 auto;padding:4px 5px 4px 12px;display:flex}.zg1olG_goalGlyph{color:var(--dsw-alias-label-tertiary);flex:none;display:inline-flex}.zg1olG_label{color:var(--dsw-alias-label-primary);flex:none;font-size:13px;font-weight:500;line-height:24px}.zg1olG_objective{min-width:0;color:var(--dsw-alias-label-primary-dimmed);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:20px;overflow:hidden}.zg1olG_error{min-width:0;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:20px;overflow:hidden}.zg1olG_objectiveInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-primary);border-radius:6px;outline:none;flex:1;padding:0 8px;font-size:13px;line-height:20px}.zg1olG_objectiveInput:focus{border-color:var(--dsw-alias-state-business-primary)}.zg1olG_objectiveInput::placeholder{color:var(--dsw-alias-label-caption)}.zg1olG_actions{flex:none;align-items:center;gap:10px;display:flex}.zg1olG_iconBtn{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.zg1olG_iconBtn:hover{background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.zg1olG_iconBtn:disabled{opacity:.4;cursor:default}";
		...
		var GoalBar_module_css_default = {
			"objective": "zg1olG_objective",
			"bar": "zg1olG_bar",
			"goalGlyph": "zg1olG_goalGlyph",
			"label": "zg1olG_label",
			"error": "zg1olG_error",
			"dock": "zg1olG_dock",
			"actions": "zg1olG_actions",
			"iconBtn": "zg1olG_iconBtn",
			"objectiveInput": "zg1olG_objectiveInput"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-goal\src\client\GoalCommandInputView.module.css.mjs
		const css = "._6S6rMq_row{flex-direction:column;align-items:flex-end;gap:6px;display:flex}._6S6rMq_stack{flex-direction:column;align-items:flex-end;min-width:0;max-width:min(525px,82%);display:flex}._6S6rMq_bubble{overflow-wrap:anywhere;background:var(--dsw-specific-bubble);max-width:100%;color:var(--dsw-alias-label-primary);font:var(--dsw-font-markdown-code);white-space:pre-wrap;border-radius:22px;padding:10px 16px}";
