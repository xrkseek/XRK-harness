window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-workspace\src\client\rows\Rows.module.css.mjs
		const css$2 = ".DW6zUq_projectRow,.DW6zUq_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.DW6zUq_projectRow:hover,.DW6zUq_sessionRow:hover,.DW6zUq_sessionRow.DW6zUq_selected{background:var(--dsw-alias-interactive-bg-hover)}.DW6zUq_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.DW6zUq_searchResultRow:hover,.DW6zUq_searchResultRow.DW6zUq_selected{background:var(--dsw-alias-interactive-bg-hover)}.DW6zUq_searchResultHeading{align-items:center;min-width:0;display:flex}.DW6zUq_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.DW6zUq_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.DW6zUq_searchResultWorkspace,.DW6zUq_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.DW6zUq_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.DW6zUq_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.DW6zUq_projectRow{box-sizing:border-box;align-items:center;height:34px}.DW6zUq_projectRow .DW6zUq_rowActions{height:20px}.DW6zUq_sessionRow{height:32px;animation:DW6zUq_row-in .15s var(--ds-ease-in-out);gap:0}.DW6zUq_sessionRow .DW6zUq_title{margin:0 6px 0 4px}.DW6zUq_flatSessionRowWithoutStatus .DW6zUq_title{margin-left:0}@keyframes DW6zUq_row-in{0%{opacity:0}}.DW6zUq_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.DW6zUq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.DW6zUq_folderActive{color:var(--dsw-alias-state-business-primary)}.DW6zUq_projectRow .DW6zUq_chevron{display:none}.DW6zUq_projectRow:hover .DW6zUq_chevron{display:inline-flex}.DW6zUq_projectRow:hover .DW6zUq_folder{display:none}.DW6zUq_arrow{transition:transform .15s var(--ds-ease-in-out)}.DW6zUq_arrowOpen{transform:rotate(90deg)}.DW6zUq_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.DW6zUq_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.DW6zUq_renameInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.DW6zUq_sessionRow .DW6zUq_title{flex:1}.DW6zUq_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.DW6zUq_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.DW6zUq_dot{flex:none}.DW6zUq_rowActions{flex:none;align-items:center;gap:12px;display:none}.DW6zUq_projectRow:hover .DW6zUq_rowActions,.DW6zUq_sessionRow:hover .DW6zUq_rowActions,.DW6zUq_projectRow.DW6zUq_menuOpen .DW6zUq_rowActions,.DW6zUq_sessionRow.DW6zUq_menuOpen .DW6zUq_rowActions{display:inline-flex}.DW6zUq_sessionRow:hover .DW6zUq_time,.DW6zUq_sessionRow.DW6zUq_menuOpen .DW6zUq_time{display:none}.DW6zUq_projectRow.DW6zUq_menuOpen,.DW6zUq_sessionRow.DW6zUq_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.DW6zUq_sessionRow.DW6zUq_dropBefore,.DW6zUq_sessionRow.DW6zUq_dropAfter{position:relative}.DW6zUq_sessionRow.DW6zUq_dropBefore:before,.DW6zUq_sessionRow.DW6zUq_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.DW6zUq_sessionRow.DW6zUq_dropBefore:before{top:-7px}.DW6zUq_sessionRow.DW6zUq_dropAfter:after{bottom:-7px}.DW6zUq_hoverContent{flex-direction:column;gap:8px;display:flex}.DW6zUq_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.DW6zUq_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.DW6zUq_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.DW6zUq_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.DW6zUq_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.DW6zUq_iconButton:hover{color:var(--dsw-alias-label-primary)}.DW6zUq_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.DW6zUq_sessionRow,.DW6zUq_arrow{transition:none;animation:none}}";
		...
		var Rows_module_css_default = {
			"searchResultRow": "DW6zUq_searchResultRow",
			"hoverContent": "DW6zUq_hoverContent",
			"rowActions": "DW6zUq_rowActions",
			"searchResultMeta": "DW6zUq_searchResultMeta",
			"searchResultWorkspace": "DW6zUq_searchResultWorkspace",
			"flatSessionRowWithoutStatus": "DW6zUq_flatSessionRowWithoutStatus",
			"hoverTitle": "DW6zUq_hoverTitle",
			"hoverPath": "DW6zUq_hoverPath",
			"searchResultTitle": "DW6zUq_searchResultTitle",
			"hoverTime": "DW6zUq_hoverTime",
			"chevron": "DW6zUq_chevron",
			"searchResultHeading": "DW6zUq_searchResultHeading",
			"searchResultSnippet": "DW6zUq_searchResultSnippet",
			"meta": "DW6zUq_meta",
			"sessionRow": "DW6zUq_sessionRow",
			"row-in": "DW6zUq_row-in",
			"renameInput": "DW6zUq_renameInput",
			"dropAfter": "DW6zUq_dropAfter",
			"title": "DW6zUq_title",
			"visuallyHidden": "DW6zUq_visuallyHidden",
			"arrowOpen": "DW6zUq_arrowOpen",
			"folder": "DW6zUq_folder",
			"selected": "DW6zUq_selected",
			"arrow": "DW6zUq_arrow",
			"time": "DW6zUq_time",
			"projectRow": "DW6zUq_projectRow",
			"slot": "DW6zUq_slot",
			"iconButton": "DW6zUq_iconButton",
			"dropBefore": "DW6zUq_dropBefore",
			"hoverStatus": "DW6zUq_hoverStatus",
			"folderActive": "DW6zUq_folderActive",
			"projectText": "DW6zUq_projectText",
			"dot": "DW6zUq_dot",
			"menuOpen": "DW6zUq_menuOpen"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-workspace\src\client\WorkspacePicker.module.css.mjs
		const css$1 = ".U1a0-q_modalAction{min-width:72px}.U1a0-q_modalError,.U1a0-q_menuStatus{margin-top:8px;font-size:12px;line-height:18px}.U1a0-q_modalError{color:var(--dsw-alias-state-error-primary)}.U1a0-q_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		var WorkspacePicker_module_css_default = {
			"menuStatus": "U1a0-q_menuStatus",
			"modalAction": "U1a0-q_modalAction",
			"modalError": "U1a0-q_modalError"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-workspace\src\client\WorkspaceBrowser.module.css.mjs
		const css = ".w-QYrW_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.w-QYrW_root.w-QYrW_rail{padding-right:0}.w-QYrW_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.w-QYrW_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.w-QYrW_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.w-QYrW_root:not(.w-QYrW_rail) .w-QYrW_sectionHeader{margin-top:2px;margin-right:-4px}.w-QYrW_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.w-QYrW_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.w-QYrW_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.w-QYrW_searchSlotExpanded{max-width:100%;padding-left:0}.w-QYrW_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.w-QYrW_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.w-QYrW_search{box-sizing:border-box;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.w-QYrW_searchExpanded{border:1px solid var(--dsw-alias-border-l2);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}.w-QYrW_searchButton{cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.w-QYrW_searchExpanded .w-QYrW_searchButton{width:28px;height:30px}.w-QYrW_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.w-QYrW_searchExpanded .w-QYrW_searchButton:hover{background:0 0}.w-QYrW_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.w-QYrW_searchExpanded .w-QYrW_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.w-QYrW_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.w-QYrW_clearButton{cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.w-QYrW_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.w-QYrW_rail .w-QYrW_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.w-QYrW_rail .w-QYrW_headerActions{max-width:none}.w-QYrW_rail .w-QYrW_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.w-QYrW_rail .w-QYrW_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.w-QYrW_rail .w-QYrW_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.w-QYrW_rail .w-QYrW_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.w-QYrW_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.w-QYrW_rail .w-QYrW_listArea{margin-left:0;margin-right:0;padding-left:0}.w-QYrW_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.w-QYrW_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.w-QYrW_wide{animation:w-QYrW_wide-in .2s var(--ds-ease-in-out)}@keyframes w-QYrW_wide-in{0%{opacity:0}}.w-QYrW_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.w-QYrW_flatList>*+*,.w-QYrW_searchTree>[role=treeitem]+[role=treeitem],.w-QYrW_groupSection>*+*{margin-top:2px}.w-QYrW_searchStatus,.w-QYrW_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.w-QYrW_searchWarning{color:var(--dsw-alias-label-secondary)}.w-QYrW_groupSection{position:relative}.w-QYrW_groupSection+.w-QYrW_groupSection{margin-top:4px}.w-QYrW_listTopDropIndicator,.w-QYrW_workspaceDropBefore:before,.w-QYrW_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.w-QYrW_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.w-QYrW_listTopDropActive>.w-QYrW_workspaceDropBefore:first-child:before{display:none}.w-QYrW_workspaceDropBefore:before{top:-8px}.w-QYrW_workspaceDropAfter:after{bottom:-8px}.w-QYrW_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.w-QYrW_groupSection>.w-QYrW_sessionOverflowButton{margin-top:0}.w-QYrW_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.w-QYrW_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.w-QYrW_renameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.w-QYrW_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.w-QYrW_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.w-QYrW_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.w-QYrW_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.w-QYrW_wide{animation:none}.w-QYrW_search,.w-QYrW_sectionLabel,.w-QYrW_searchSlot,.w-QYrW_searchInput,.w-QYrW_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"searchStatus": "w-QYrW_searchStatus",
			"searchSlotExpanded": "w-QYrW_searchSlotExpanded",
			"headerActionsHidden": "w-QYrW_headerActionsHidden",
			"root": "w-QYrW_root",
			"deleteStatus": "w-QYrW_deleteStatus",
			"searchSlot": "w-QYrW_searchSlot",
			"searchInput": "w-QYrW_searchInput",
			"fade": "w-QYrW_fade",
			"wide": "w-QYrW_wide",
			"search": "w-QYrW_search",
			"sectionLabelHidden": "w-QYrW_sectionLabelHidden",
			"clearButton": "w-QYrW_clearButton",
			"wide-in": "w-QYrW_wide-in",
			"sectionHeader": "w-QYrW_sectionHeader",
			"list": "w-QYrW_list",
			"renameInput": "w-QYrW_renameInput",
			"workspaceDropAfter": "w-QYrW_workspaceDropAfter",
			"empty": "w-QYrW_empty",
			"listTopDropActive": "w-QYrW_listTopDropActive",
			"deleteAction": "w-QYrW_deleteAction",
			"workspaceDropBefore": "w-QYrW_workspaceDropBefore",
			"listArea": "w-QYrW_listArea",
			"searchExpanded": "w-QYrW_searchExpanded",
			"iconButton": "w-QYrW_iconButton",
			"rail": "w-QYrW_rail",
			"sectionLabel": "w-QYrW_sectionLabel",
			"treeBody": "w-QYrW_treeBody",
			"headerActions": "w-QYrW_headerActions",
			"flatList": "w-QYrW_flatList",
			"listTopDropIndicator": "w-QYrW_listTopDropIndicator",
			"searchButton": "w-QYrW_searchButton",
			"searchTree": "w-QYrW_searchTree",
			"groupSection": "w-QYrW_groupSection",
			"sessionOverflowButton": "w-QYrW_sessionOverflowButton",
			"renameError": "w-QYrW_renameError",
			"searchWarning": "w-QYrW_searchWarning"
		};
		//#endregion
