window.__ModuleLoader__.load({
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryTable.module.css.mjs
		const css$3 = "._1pVkRq_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}._1pVkRq_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:_1pVkRq_trajectory-table/inline-size}._1pVkRq_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}._1pVkRq_historyLoadingBar{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}._1pVkRq_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;width:10px;height:10px;animation:.7s linear infinite _1pVkRq_history-loading-spin}._1pVkRq_table tbody ._1pVkRq_historyLoadRow td{height:30px;padding:0}._1pVkRq_table tbody ._1pVkRq_historyLoadRow+tr[data-turn-start=true] td:before{content:none}._1pVkRq_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}._1pVkRq_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._1pVkRq_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}._1pVkRq_historyLoadButton:disabled{cursor:default}._1pVkRq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}._1pVkRq_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes _1pVkRq_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){._1pVkRq_historyLoadingSpinner{animation:none}}._1pVkRq_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}._1pVkRq_eventColumn{width:122px}._1pVkRq_contentColumn{width:auto}._1pVkRq_table th{z-index:3;box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}._1pVkRq_eventHeader{text-align:right!important;padding-right:4px!important}._1pVkRq_table td{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}._1pVkRq_table tbody ._1pVkRq_virtualSpacer{pointer-events:none}._1pVkRq_table tbody ._1pVkRq_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}._1pVkRq_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}._1pVkRq_table tbody tr[data-timeline-focus=outside]{opacity:.24}._1pVkRq_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}._1pVkRq_table tbody tr[data-request-only=true]:hover{background:0 0}._1pVkRq_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}._1pVkRq_table tbody tr[data-terminal-request-boundary=true] td{height:9px}._1pVkRq_table tbody tr[data-request-only=true] ._1pVkRq_turnRail{top:-15px;bottom:0}._1pVkRq_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}._1pVkRq_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}._1pVkRq_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}._1pVkRq_requestBoundaryControl:before{background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}._1pVkRq_requestBoundaryControl:after{border:1px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}._1pVkRq_requestBoundaryControl:hover:before,._1pVkRq_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}._1pVkRq_requestBoundaryControlActive:before,._1pVkRq_requestBoundaryControlActive:hover:before,._1pVkRq_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}._1pVkRq_requestBoundaryControl[data-request-status=error]:before,._1pVkRq_requestBoundaryControl[data-request-status=error]:hover:before,._1pVkRq_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}._1pVkRq_requestBoundaryControl:hover:after,._1pVkRq_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}._1pVkRq_requestBoundaryControl:focus-visible{outline:none}._1pVkRq_table tbody tr:has(._1pVkRq_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}._1pVkRq_event{position:relative}._1pVkRq_turnRail,._1pVkRq_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}._1pVkRq_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}._1pVkRq_table tbody tr[data-turn-end=true] ._1pVkRq_turnRail{bottom:0}._1pVkRq_selectionRail{z-index:5;width:3px;top:0;bottom:0}._1pVkRq_table tbody tr[data-error=true] ._1pVkRq_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}._1pVkRq_table tbody tr[data-error=true] ._1pVkRq_selectionRail{background:var(--dsw-alias-state-error-primary)}._1pVkRq_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}._1pVkRq_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}._1pVkRq_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}._1pVkRq_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}._1pVkRq_turnLabelFull,._1pVkRq_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}._1pVkRq_turnLabelCompact{opacity:0;max-width:0}._1pVkRq_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}._1pVkRq_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}._1pVkRq_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}._1pVkRq_kindSlot [role=tooltip]{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary)}._1pVkRq_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}._1pVkRq_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}._1pVkRq_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}._1pVkRq_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}._1pVkRq_table ._1pVkRq_kindSlot ._1pVkRq_message{justify-content:center;width:100%}@container _1pVkRq_trajectory-table (width<=620px){._1pVkRq_eventColumn{width:50px}._1pVkRq_event{padding-left:28px!important;padding-right:3px!important}._1pVkRq_requestBoundaryControl{--request-boundary-base-left:6px}._1pVkRq_kindSlot{width:19px}._1pVkRq_kindTag,._1pVkRq_table ._1pVkRq_kindSlot ._1pVkRq_message{justify-content:center;width:19px;padding-left:0;padding-right:0}._1pVkRq_kindTagIcon{opacity:1;width:13px;transform:scale(1)}._1pVkRq_kindTagLabel,._1pVkRq_turnLabelFull{opacity:0;max-width:0}._1pVkRq_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){._1pVkRq_eventColumn,._1pVkRq_event,._1pVkRq_requestBoundaryControl,._1pVkRq_kindSlot,._1pVkRq_kindTag,._1pVkRq_kindTagIcon,._1pVkRq_kindTagLabel,._1pVkRq_turnLabelFull,._1pVkRq_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}._1pVkRq_eventColumn,._1pVkRq_kindSlot{transition-property:width}._1pVkRq_event{transition-property:padding-right,padding-left}._1pVkRq_requestBoundaryControl{transition-property:left}._1pVkRq_kindTag{transition-property:padding-right,padding-left}._1pVkRq_kindTagIcon{transition-property:width,opacity,transform}._1pVkRq_kindTagLabel,._1pVkRq_turnLabelFull,._1pVkRq_turnLabelCompact{transition-property:max-width,opacity}}._1pVkRq_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}._1pVkRq_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}._1pVkRq_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}._1pVkRq_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}._1pVkRq_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}._1pVkRq_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}._1pVkRq_promptDiffSection{min-width:0}._1pVkRq_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}._1pVkRq_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}._1pVkRq_promptDiff span{min-width:max-content;padding:0 6px;display:block}._1pVkRq_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}._1pVkRq_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}._1pVkRq_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}._1pVkRq_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}._1pVkRq_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}._1pVkRq_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}._1pVkRq_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}._1pVkRq_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}._1pVkRq_toolCallOnly{color:var(--dsw-alias-label-tertiary)}._1pVkRq_table tbody tr[data-collapsed-summary=turn] td,._1pVkRq_table tbody tr[data-collapsed-summary=assistant] td{height:20px}._1pVkRq_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}._1pVkRq_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}._1pVkRq_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}._1pVkRq_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}._1pVkRq_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}._1pVkRq_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}._1pVkRq_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}._1pVkRq_resultRequest,._1pVkRq_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}._1pVkRq_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}._1pVkRq_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}._1pVkRq_table tbody tr[data-kind=tool] ._1pVkRq_contentText,._1pVkRq_table tbody tr[data-kind=subtool] ._1pVkRq_contentText,._1pVkRq_table tbody tr[data-kind=tool] ._1pVkRq_resultPreview,._1pVkRq_table tbody tr[data-kind=subtool] ._1pVkRq_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}._1pVkRq_table tbody tr[data-kind=subtool] ._1pVkRq_content{padding-left:26px}._1pVkRq_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}._1pVkRq_noOutputText{color:var(--dsw-alias-label-caption)}._1pVkRq_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}._1pVkRq_error,._1pVkRq_overview dd._1pVkRq_error,._1pVkRq_details ._1pVkRq_errorPayload{color:var(--dsw-alias-state-error-primary)}._1pVkRq_details ._1pVkRq_errorPayload ._1pVkRq_resultBlockText{color:inherit}._1pVkRq_details ._1pVkRq_jsonPayload._1pVkRq_errorPayload,._1pVkRq_details ._1pVkRq_jsonPreview._1pVkRq_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}._1pVkRq_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}._1pVkRq_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}._1pVkRq_detailsResizeHandle:focus-visible{outline:none}._1pVkRq_detailsHeader{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}._1pVkRq_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}._1pVkRq_requestDetailsDot{background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}._1pVkRq_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}._1pVkRq_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._1pVkRq_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}._1pVkRq_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}._1pVkRq_detailTabs{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}._1pVkRq_detailTabs::-webkit-scrollbar{display:none}._1pVkRq_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}._1pVkRq_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}._1pVkRq_detailTabActive{color:var(--dsw-alias-state-business-primary)}._1pVkRq_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}._1pVkRq_close:focus-visible,._1pVkRq_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._1pVkRq_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}._1pVkRq_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}._1pVkRq_detailBodySummary>._1pVkRq_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}._1pVkRq_detailBodySummary>._1pVkRq_compactedSummary{flex:1;min-height:0;overflow:auto}._1pVkRq_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}._1pVkRq_summaryScrollRegion:hover,._1pVkRq_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}._1pVkRq_compactedSummary ._1pVkRq_markdownPayload{padding-right:18px}._1pVkRq_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}._1pVkRq_overviewParentLinks{gap:14px;display:flex}._1pVkRq_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}._1pVkRq_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}._1pVkRq_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}._1pVkRq_overviewHierarchyNavLink:hover ._1pVkRq_overviewHierarchyJumpIconTight,._1pVkRq_overviewHierarchyNavLink:focus-visible ._1pVkRq_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}._1pVkRq_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._1pVkRq_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}._1pVkRq_overview>._1pVkRq_requestTokenDetail dt{padding-left:12px}._1pVkRq_usagePanel{padding:4px 0 10px}._1pVkRq_usageGroup+._1pVkRq_usageGroup{margin-top:8px}._1pVkRq_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}._1pVkRq_usageGroup ._1pVkRq_overview{padding:0}._1pVkRq_overview dt{color:var(--dsw-alias-label-tertiary)}._1pVkRq_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}._1pVkRq_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}._1pVkRq_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._1pVkRq_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}._1pVkRq_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}._1pVkRq_overviewSection+._1pVkRq_overviewSection{padding-top:8px}._1pVkRq_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}._1pVkRq_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}._1pVkRq_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}._1pVkRq_overviewTitle:hover ._1pVkRq_overviewTitleIcon{color:var(--dsw-alias-label-primary)}._1pVkRq_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._1pVkRq_overviewTitle:focus-visible ._1pVkRq_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}._1pVkRq_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}._1pVkRq_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}._1pVkRq_overviewPreview ._1pVkRq_jsonPreview>:first-child,._1pVkRq_overviewPreview ._1pVkRq_schemaTree>:first-child{padding-bottom:0}._1pVkRq_overviewPreview ._1pVkRq_schemaTree{margin-bottom:0}._1pVkRq_overviewPreview ._1pVkRq_overview{padding:2px 0 0}._1pVkRq_overviewPreview ._1pVkRq_overview>div{min-height:22px}._1pVkRq_markdownPreview,._1pVkRq_markdownPayload{color:var(--dsw-alias-label-primary)}._1pVkRq_markdownPreview>div,._1pVkRq_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}._1pVkRq_markdownPreview>div h1,._1pVkRq_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}._1pVkRq_markdownPreview>div h2,._1pVkRq_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}._1pVkRq_markdownPreview>div :where(h3,h4,h5,h6),._1pVkRq_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}._1pVkRq_markdownPreview>div :not(pre)>code,._1pVkRq_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}._1pVkRq_markdownPreview>div table,._1pVkRq_markdownPayload>div table{font:var(--dsw-font-xs-13)}._1pVkRq_markdownPreview>div>:first-child{margin-top:0}._1pVkRq_markdownPreview>div>:last-child{margin-bottom:0}._1pVkRq_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}._1pVkRq_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}._1pVkRq_markdownPreview>div :where(p,ul,ol){margin:8px 0}._1pVkRq_markdownPreview>div li:not(:first-child){margin-top:3px}._1pVkRq_markdownPreview>div blockquote{margin-top:8px}._1pVkRq_markdownPreview>div hr{margin:14px 0}._1pVkRq_markdownPreview>div>.md-code-block{margin:10px 0}._1pVkRq_assistantContent ._1pVkRq_markdownPayload,._1pVkRq_assistantContent ._1pVkRq_payload{min-height:0}._1pVkRq_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}._1pVkRq_thinkingQuoteOnlyPreview{margin-bottom:8px}._1pVkRq_detailBody>._1pVkRq_assistantContentRendered ._1pVkRq_thinkingQuote{margin-top:14px}._1pVkRq_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}._1pVkRq_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}._1pVkRq_thinkingToggle[aria-expanded=true] ._1pVkRq_thinkingChevron{transform:rotate(90deg)}._1pVkRq_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}._1pVkRq_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}._1pVkRq_thinkingQuote ._1pVkRq_markdownPreview,._1pVkRq_thinkingQuote ._1pVkRq_markdownPayload,._1pVkRq_thinkingQuote ._1pVkRq_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}._1pVkRq_assistantOutput{background:var(--dsw-alias-bg-layer-1)}._1pVkRq_markdownPreview{padding:6px 14px 8px}._1pVkRq_markdownPayload{min-height:100%;padding:14px}._1pVkRq_jsonPayload{min-height:100%}._1pVkRq_jsonPreview{min-height:0}._1pVkRq_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}._1pVkRq_schemaPreview{min-height:0}._1pVkRq_schemaIntro{padding:12px 14px 6px}._1pVkRq_schemaPreview ._1pVkRq_schemaIntro{padding-top:6px}._1pVkRq_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}._1pVkRq_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}._1pVkRq_schemaParameters{min-width:0}._1pVkRq_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}._1pVkRq_schemaTree{margin:0 6px 8px 0}._1pVkRq_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}._1pVkRq_payloadPreview{min-height:0;padding:6px 14px 8px}._1pVkRq_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}._1pVkRq_sourceBlock+._1pVkRq_sourceBlock{margin-top:14px}._1pVkRq_sourceBlockHeader,._1pVkRq_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}._1pVkRq_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}._1pVkRq_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}._1pVkRq_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}._1pVkRq_sourceBlockJumpTarget:hover ._1pVkRq_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}._1pVkRq_sourceBlockJumpTarget:focus-visible{outline:none}._1pVkRq_sourceBlockJumpTarget:focus-visible ._1pVkRq_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}._1pVkRq_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}._1pVkRq_panelImageLink{cursor:zoom-in;border-radius:4px;width:auto;max-width:100%;display:block;overflow:hidden}._1pVkRq_panelImageLinkPreview{max-height:140px}._1pVkRq_panelImage{border-radius:inherit;background:var(--dsw-alias-bg-base);object-fit:contain;width:auto;max-width:100%;height:auto;max-height:320px;margin:0;display:block}._1pVkRq_panelImageLinkPreview ._1pVkRq_panelImage{max-height:140px}._1pVkRq_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}._1pVkRq_messageImagesPreview{gap:6px;margin:6px 14px 8px}._1pVkRq_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}._1pVkRq_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}._1pVkRq_assistantToolCalls li{min-width:0}._1pVkRq_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}._1pVkRq_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._1pVkRq_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._1pVkRq_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}._1pVkRq_assistantToolCallButton:hover ._1pVkRq_assistantToolCallIcon,._1pVkRq_assistantToolCallButton:focus-visible ._1pVkRq_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}._1pVkRq_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}._1pVkRq_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}._1pVkRq_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._1pVkRq_systemPrompt{box-sizing:border-box}._1pVkRq_toolCatalog{min-height:100%;padding:8px 0 16px}._1pVkRq_toolCatalogItem{border-bottom:1px solid var(--dsw-alias-border-l1)}._1pVkRq_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}._1pVkRq_toolCatalogSummary::-webkit-details-marker{display:none}._1pVkRq_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}._1pVkRq_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._1pVkRq_toolCatalogChevron,._1pVkRq_toolCatalogIcon{color:var(--dsw-alias-label-caption)}._1pVkRq_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}._1pVkRq_toolCatalogItem[open] ._1pVkRq_toolCatalogChevron{transform:rotate(90deg)}._1pVkRq_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}._1pVkRq_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._1pVkRq_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}._1pVkRq_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}._1pVkRq_toolCatalogTree{margin-left:-14px;margin-right:6px}._1pVkRq_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}._1pVkRq_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}._1pVkRq_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}._1pVkRq_overviewPreview ._1pVkRq_noPayload{padding:6px 14px 8px}._1pVkRq_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){._1pVkRq_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"markdownPreview": "_1pVkRq_markdownPreview",
			"error": "_1pVkRq_error",
			"toolCatalogDefinition": "_1pVkRq_toolCatalogDefinition",
			"payload": "_1pVkRq_payload",
			"historyLoadRow": "_1pVkRq_historyLoadRow",
			"toolCallNameTypeface": "_1pVkRq_toolCallNameTypeface",
			"user": "_1pVkRq_user",
			"payloadPreview": "_1pVkRq_payloadPreview",
			"sourceBlockJumpIcon": "_1pVkRq_sourceBlockJumpIcon",
			"collapsedTurnEllipsis": "_1pVkRq_collapsedTurnEllipsis",
			"details": "_1pVkRq_details",
			"compacted": "_1pVkRq_compacted",
			"collapsedTurnContent": "_1pVkRq_collapsedTurnContent",
			"detailsLocation": "_1pVkRq_detailsLocation",
			"compactedSummary": "_1pVkRq_compactedSummary",
			"sourceBlocks": "_1pVkRq_sourceBlocks",
			"resultBlocksPreview": "_1pVkRq_resultBlocksPreview",
			"usageGroup": "_1pVkRq_usageGroup",
			"historyLoadButton": "_1pVkRq_historyLoadButton",
			"split": "_1pVkRq_split",
			"thinkingQuoteOnlyPreview": "_1pVkRq_thinkingQuoteOnlyPreview",
			"tablePane": "_1pVkRq_tablePane",
			"close": "_1pVkRq_close",
			"overviewTitle": "_1pVkRq_overviewTitle",
			"schemaParameters": "_1pVkRq_schemaParameters",
			"sourceBlock": "_1pVkRq_sourceBlock",
			"assistantOutput": "_1pVkRq_assistantOutput",
			"promptDiffSections": "_1pVkRq_promptDiffSections",
			"toolCallOnly": "_1pVkRq_toolCallOnly",
			"history-loading-spin": "_1pVkRq_history-loading-spin",
			"resultBlockText": "_1pVkRq_resultBlockText",
			"schema": "_1pVkRq_schema",
			"subtoolAmber": "_1pVkRq_subtoolAmber",
			"toolCatalogSummary": "_1pVkRq_toolCatalogSummary",
			"toolCallPayload": "_1pVkRq_toolCallPayload",
			"jsonPayload": "_1pVkRq_jsonPayload",
			"thinkingQuote": "_1pVkRq_thinkingQuote",
			"selectionRail": "_1pVkRq_selectionRail",
			"noPayload": "_1pVkRq_noPayload",
			"turnLabelCompact": "_1pVkRq_turnLabelCompact",
			"arrow": "_1pVkRq_arrow",
			"usagePanel": "_1pVkRq_usagePanel",
			"promptDiffLineremoved": "_1pVkRq_promptDiffLineremoved",
			"assistantToolCalls": "_1pVkRq_assistantToolCalls",
			"toolCatalogItem": "_1pVkRq_toolCatalogItem",
			"kindTagIcon": "_1pVkRq_kindTagIcon",
			"kindTagLabel": "_1pVkRq_kindTagLabel",
			"overviewSections": "_1pVkRq_overviewSections",
			"toolCatalogTree": "_1pVkRq_toolCatalogTree",
			"assistantToolCallsPreview": "_1pVkRq_assistantToolCallsPreview",
			"requestDetailsName": "_1pVkRq_requestDetailsName",
			"assistantToolCallText": "_1pVkRq_assistantToolCallText",
			"schemaParametersTitle": "_1pVkRq_schemaParametersTitle",
			"schemaName": "_1pVkRq_schemaName",
			"sourceBlockJumpTarget": "_1pVkRq_sourceBlockJumpTarget",
			"table": "_1pVkRq_table",
			"overviewSection": "_1pVkRq_overviewSection",
			"resultRequest": "_1pVkRq_resultRequest",
			"detailsHeader": "_1pVkRq_detailsHeader",
			"promptDiffTitle": "_1pVkRq_promptDiffTitle",
			"promptDiffLineadded": "_1pVkRq_promptDiffLineadded",
			"errorPayload": "_1pVkRq_errorPayload",
			"assistantToolCallArgs": "_1pVkRq_assistantToolCallArgs",
			"historyLoading": "_1pVkRq_historyLoading",
			"promptDiff": "_1pVkRq_promptDiff",
			"toolCatalogDescription": "_1pVkRq_toolCatalogDescription",
			"messageImages": "_1pVkRq_messageImages",
			"requestDetailsDot": "_1pVkRq_requestDetailsDot",
			"detailBody": "_1pVkRq_detailBody",
			"resultPreview": "_1pVkRq_resultPreview",
			"overviewHierarchyNavLink": "_1pVkRq_overviewHierarchyNavLink",
			"requestBoundaryControl": "_1pVkRq_requestBoundaryControl",
			"usageHeading": "_1pVkRq_usageHeading",
			"eventHeader": "_1pVkRq_eventHeader",
			"toolAmber": "_1pVkRq_toolAmber",
			"detailBodySummary": "_1pVkRq_detailBodySummary",
			"content": "_1pVkRq_content",
			"jsonPreview": "_1pVkRq_jsonPreview",
			"detailTabActive": "_1pVkRq_detailTabActive",
			"schemaTree": "_1pVkRq_schemaTree",
			"promptDiffSection": "_1pVkRq_promptDiffSection",
			"overviewTitleIcon": "_1pVkRq_overviewTitleIcon",
			"promptDiffLinemeta": "_1pVkRq_promptDiffLinemeta",
			"contentText": "_1pVkRq_contentText",
			"overviewHierarchyJumpIconTight": "_1pVkRq_overviewHierarchyJumpIconTight",
			"overviewPreview": "_1pVkRq_overviewPreview",
			"kindTag": "_1pVkRq_kindTag",
			"timestampToggle": "_1pVkRq_timestampToggle",
			"toolCatalogIcon": "_1pVkRq_toolCatalogIcon",
			"turnLabelFull": "_1pVkRq_turnLabelFull",
			"summaryScrollRegion": "_1pVkRq_summaryScrollRegion",
			"detailTab": "_1pVkRq_detailTab",
			"systemPrompt": "_1pVkRq_systemPrompt",
			"inlineResult": "_1pVkRq_inlineResult",
			"systemNeutral": "_1pVkRq_systemNeutral",
			"visuallyHidden": "_1pVkRq_visuallyHidden",
			"detailTabs": "_1pVkRq_detailTabs",
			"overview": "_1pVkRq_overview",
			"sourceBlockContent": "_1pVkRq_sourceBlockContent",
			"overviewHeading": "_1pVkRq_overviewHeading",
			"toolCatalog": "_1pVkRq_toolCatalog",
			"thinkingToggle": "_1pVkRq_thinkingToggle",
			"panelImageLinkPreview": "_1pVkRq_panelImageLinkPreview",
			"assistantVioletBright": "_1pVkRq_assistantVioletBright",
			"resultBlocks": "_1pVkRq_resultBlocks",
			"requestBoundaryControlActive": "_1pVkRq_requestBoundaryControlActive",
			"contextGreen": "_1pVkRq_contextGreen",
			"eventInner": "_1pVkRq_eventInner",
			"message": "_1pVkRq_message",
			"historyLoadingSpinner": "_1pVkRq_historyLoadingSpinner",
			"messageImagesPreview": "_1pVkRq_messageImagesPreview",
			"kindSlot": "_1pVkRq_kindSlot",
			"thinkingChevron": "_1pVkRq_thinkingChevron",
			"schemaDescription": "_1pVkRq_schemaDescription",
			"assistantToolCallButton": "_1pVkRq_assistantToolCallButton",
			"historyLoadingBar": "_1pVkRq_historyLoadingBar",
			"schemaIntro": "_1pVkRq_schemaIntro",
			"overviewParentLinks": "_1pVkRq_overviewParentLinks",
			"sourceBlockLabel": "_1pVkRq_sourceBlockLabel",
			"detailsTitle": "_1pVkRq_detailsTitle",
			"panelImageLink": "_1pVkRq_panelImageLink",
			"eventColumn": "_1pVkRq_eventColumn",
			"detailsResizeHandle": "_1pVkRq_detailsResizeHandle",
			"turnRail": "_1pVkRq_turnRail",
			"turnLabel": "_1pVkRq_turnLabel",
			"sourceBlockHeader": "_1pVkRq_sourceBlockHeader",
			"collapsedTurnText": "_1pVkRq_collapsedTurnText",
			"assistantContent": "_1pVkRq_assistantContent",
			"noOutputText": "_1pVkRq_noOutputText",
			"inlineResultText": "_1pVkRq_inlineResultText",
			"promptDiffLinecontext": "_1pVkRq_promptDiffLinecontext",
			"turnLabelActive": "_1pVkRq_turnLabelActive",
			"requestTokenDetail": "_1pVkRq_requestTokenDetail",
			"panelImage": "_1pVkRq_panelImage",
			"assistantToolCallIcon": "_1pVkRq_assistantToolCallIcon",
			"toolCatalogChevron": "_1pVkRq_toolCatalogChevron",
			"toolCatalogFullDescription": "_1pVkRq_toolCatalogFullDescription",
			"assistantToolCallName": "_1pVkRq_assistantToolCallName",
			"event": "_1pVkRq_event",
			"markdownPayload": "_1pVkRq_markdownPayload",
			"assistantContentRendered": "_1pVkRq_assistantContentRendered",
			"schemaPreview": "_1pVkRq_schemaPreview",
			"toolCatalogName": "_1pVkRq_toolCatalogName",
			"trajectory-table": "_1pVkRq_trajectory-table",
			"virtualSpacer": "_1pVkRq_virtualSpacer",
			"contentColumn": "_1pVkRq_contentColumn"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryToolbar.module.css.mjs
		const css$2 = ".XTOcRq_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}.XTOcRq_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}.XTOcRq_actions{flex:none;align-items:center;gap:2px;display:flex}.XTOcRq_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}.XTOcRq_toggle:hover,.XTOcRq_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.XTOcRq_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.XTOcRq_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}.XTOcRq_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.XTOcRq_control[hidden]{display:none}.XTOcRq_control:hover:not(:disabled),.XTOcRq_control[aria-checked=true],.XTOcRq_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}.XTOcRq_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.XTOcRq_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.XTOcRq_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}.XTOcRq_controlThumb{background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}.XTOcRq_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}.XTOcRq_controlTrack[data-on=true] .XTOcRq_controlThumb{transform:translate(10px)}.XTOcRq_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.XTOcRq_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.XTOcRq_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.XTOcRq_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}.XTOcRq_search{border:1px solid var(--dsw-alias-border-l2);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}.XTOcRq_search:hover{border-color:var(--dsw-alias-label-caption)}.XTOcRq_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}.XTOcRq_searchIcon{flex:none}.XTOcRq_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}.XTOcRq_searchInput::placeholder{color:var(--dsw-alias-label-caption)}.XTOcRq_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"toggle": "XTOcRq_toggle",
			"search": "XTOcRq_search",
			"control": "XTOcRq_control",
			"controlTrack": "XTOcRq_controlTrack",
			"toggleIcon": "XTOcRq_toggleIcon",
			"action": "XTOcRq_action",
			"inner": "XTOcRq_inner",
			"searchInput": "XTOcRq_searchInput",
			"root": "XTOcRq_root",
			"actions": "XTOcRq_actions",
			"controlThumb": "XTOcRq_controlThumb",
			"actionIcon": "XTOcRq_actionIcon",
			"searchIcon": "XTOcRq_searchIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryTimeline.module.css.mjs
		const css$1 = "._9EYLRW_root{z-index:1;isolation:isolate;border-bottom:1px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}._9EYLRW_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}._9EYLRW_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}._9EYLRW_labels{border-right:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}._9EYLRW_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}._9EYLRW_labels span:first-child{top:7px}._9EYLRW_labels span:nth-child(2){top:21px}._9EYLRW_labels span:nth-child(3){top:35px}._9EYLRW_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}._9EYLRW_track[data-panning=true]{cursor:grabbing}._9EYLRW_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}._9EYLRW_earlierHistory:hover{opacity:1}._9EYLRW_earlierHistory[aria-disabled=true]{cursor:default}._9EYLRW_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}._9EYLRW_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}._9EYLRW_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}._9EYLRW_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}._9EYLRW_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){._9EYLRW_lanes[data-animate-viewport=true],._9EYLRW_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}._9EYLRW_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:1px;position:absolute}._9EYLRW_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}._9EYLRW_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}._9EYLRW_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}._9EYLRW_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}._9EYLRW_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}._9EYLRW_span[data-timeline-span=tool],._9EYLRW_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}._9EYLRW_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}._9EYLRW_span[data-equal-duration=true]{width:8px;min-width:8px}._9EYLRW_span[data-selected=false]{opacity:.2}._9EYLRW_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}._9EYLRW_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}._9EYLRW_span[data-search-match=false]{opacity:.14}._9EYLRW_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}._9EYLRW_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}._9EYLRW_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}._9EYLRW_selectionEdges:before,._9EYLRW_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}._9EYLRW_selectionEdges:before{left:0}._9EYLRW_selectionEdges:after{right:0}._9EYLRW_selectionEdges[data-dragging=true]:before,._9EYLRW_selectionEdges[data-dragging=true]:after{width:2px}._9EYLRW_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"selectionEdges": "_9EYLRW_selectionEdges",
			"hoverLine": "_9EYLRW_hoverLine",
			"span": "_9EYLRW_span",
			"turnBoundaries": "_9EYLRW_turnBoundaries",
			"plot": "_9EYLRW_plot",
			"earlierHistory": "_9EYLRW_earlierHistory",
			"selection": "_9EYLRW_selection",
			"turnBoundary": "_9EYLRW_turnBoundary",
			"lanes": "_9EYLRW_lanes",
			"empty": "_9EYLRW_empty",
			"root": "_9EYLRW_root",
			"labels": "_9EYLRW_labels",
			"track": "_9EYLRW_track"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-trajectory\src\client\views.module.css.mjs
		const css = ".vVvyXa_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}.vVvyXa_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
