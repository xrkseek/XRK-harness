window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-user-questions\src\client\PlanReviewPanel.module.css.mjs
		const css$1 = ".kbMIea_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.kbMIea_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;display:flex;overflow:hidden}.kbMIea_card,.kbMIea_card *{box-sizing:border-box}.kbMIea_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);flex-shrink:0;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}.kbMIea_dot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}.kbMIea_body{overscroll-behavior:contain;flex:auto;min-height:0;padding:12px 16px 4px;font-size:14px;line-height:22px;overflow-y:auto}.kbMIea_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;padding:8px 16px 12px;display:flex}.kbMIea_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:16px}.kbMIea_actions{flex-shrink:0;align-items:center;gap:8px;display:flex}.kbMIea_discuss{color:var(--dsw-alias-label-secondary);gap:6px}.kbMIea_discuss:hover:not(:disabled){color:var(--dsw-alias-label-primary)}@media (width<=720px){.kbMIea_card{border-radius:16px}.kbMIea_body{padding:10px 12px 4px}.kbMIea_footer{align-items:flex-end;padding:8px 12px 10px}}";
		...
		var PlanReviewPanel_module_css_default = {
			"strip": "kbMIea_strip",
			"actions": "kbMIea_actions",
			"dot": "kbMIea_dot",
			"discuss": "kbMIea_discuss",
			"feedback": "kbMIea_feedback",
			"frame": "kbMIea_frame",
			"footer": "kbMIea_footer",
			"body": "kbMIea_body",
			"card": "kbMIea_card"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-user-questions\src\client\QuestionComposer.module.css.mjs
		const css = ".c8vWKa_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}.c8vWKa_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;padding:0 0 10px;display:flex;overflow:hidden}.c8vWKa_card,.c8vWKa_card *{box-sizing:border-box}.c8vWKa_header{flex-shrink:0;justify-content:space-between;align-items:flex-start;gap:16px;padding:20px 16px 0 24px;display:flex}.c8vWKa_headingBlock{min-width:0}.c8vWKa_eyebrow{color:var(--dsw-alias-label-tertiary);margin-bottom:5px;font-size:11px;line-height:16px}.c8vWKa_title{margin:0;font-size:16px;font-weight:500;line-height:22px}.c8vWKa_detail{margin:0 2px 8px}.c8vWKa_footerActions{flex-shrink:0;align-items:center;gap:12px;display:flex}.c8vWKa_pager{flex-shrink:0;align-items:center;gap:6px;display:flex}.c8vWKa_progress{color:var(--dsw-alias-label-secondary);white-space:nowrap;word-spacing:-2px;padding:0 4px;font-size:14px;font-weight:500;line-height:24px}.c8vWKa_iconButton{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;place-items:center;padding:0;display:grid}.c8vWKa_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.c8vWKa_iconButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}.c8vWKa_body{overscroll-behavior:contain;flex-direction:column;flex:auto;min-height:0;display:flex;overflow-y:auto}.c8vWKa_options{flex-direction:column;gap:1px;margin:8px 0 0;padding:4px 12px;display:flex}.c8vWKa_option{width:100%;min-height:40px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.c8vWKa_option:hover:not(:disabled),.c8vWKa_optionSelected{background:var(--dsw-alias-interactive-bg-hover)}.c8vWKa_optionSelected{border-color:var(--dsw-alias-border-l2)}.c8vWKa_option:disabled{cursor:default}.c8vWKa_number{background:var(--dsw-alias-bg-overlay);width:20px;height:20px;color:var(--dsw-alias-label-secondary);border-radius:6px;flex:0 0 20px;place-items:center;margin-top:2px;font-size:12px;font-weight:500;line-height:18px;display:grid}.c8vWKa_checkbox{flex:0 0 20px;place-items:center;width:20px;height:20px;margin-top:2px;display:grid}.c8vWKa_checkbox:before{content:\"\";border:1px solid var(--dsw-alias-border-l4);border-radius:4px;grid-area:1/1;width:14px;height:14px;transition:background-color .12s,border-color .12s}.c8vWKa_checkbox>svg{grid-area:1/1}.c8vWKa_checkboxChecked{color:var(--dsw-alias-label-primary-foreground)}.c8vWKa_checkboxChecked:before{border-color:var(--dsw-alias-label-primary);background:var(--dsw-alias-label-primary)}.c8vWKa_optionCopy{flex:1;min-width:0}.c8vWKa_optionLine{flex-wrap:wrap;align-items:baseline;gap:2px 6px;display:flex}.c8vWKa_optionLabel{font-size:14px;font-weight:500;line-height:24px}.c8vWKa_badge{background:var(--dsw-specific-sidebar-nav-item-active-accent);color:var(--dsw-alias-button-info-fill);border-radius:6px;padding:0 4px;font-size:11px;font-weight:600;line-height:18px}.c8vWKa_description{color:var(--dsw-alias-label-tertiary);font-size:14px;font-weight:400;line-height:24px}.c8vWKa_customRow{border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;width:100%;min-height:40px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}.c8vWKa_customRow:hover,.c8vWKa_customRow:focus-within,.c8vWKa_customRowActive{background:var(--dsw-alias-interactive-bg-hover)}.c8vWKa_customRow:focus-within,.c8vWKa_customRowActive{border-color:var(--dsw-alias-border-l2)}.c8vWKa_customInput{min-width:0;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;background:0 0;border:none;outline:none;flex:1;padding:0;font-size:14px;line-height:24px}.c8vWKa_customInput::placeholder{color:var(--dsw-alias-label-caption)}.c8vWKa_customTextarea{resize:none;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);min-height:64px;max-height:140px;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;border-radius:10px;outline:none;flex-shrink:0;margin:0 12px;padding:8px 12px;font-size:14px;line-height:24px;display:block}.c8vWKa_customTextarea:focus{border-color:var(--dsw-alias-state-business-primary)}.c8vWKa_customTextarea::placeholder{color:var(--dsw-alias-label-caption)}.c8vWKa_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding:0 10px 0 18px;display:flex}.c8vWKa_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);text-align:right;flex:1;font-size:11px;line-height:16px}@media (width<=720px){.c8vWKa_card{border-radius:16px}.c8vWKa_header{padding:10px 12px 0 18px}.c8vWKa_options{padding:4px 8px}.c8vWKa_title{font-size:15px;line-height:21px}.c8vWKa_option,.c8vWKa_customRow{padding:8px 6px}.c8vWKa_footer{align-items:flex-end;padding:0 10px}.c8vWKa_footerActions{flex-shrink:0}}@media (prefers-reduced-motion:reduce){.c8vWKa_option,.c8vWKa_customRow{transition:none}}";
		...
		var QuestionComposer_module_css_default = {
			"checkbox": "c8vWKa_checkbox",
			"customRow": "c8vWKa_customRow",
			"body": "c8vWKa_body",
			"optionLabel": "c8vWKa_optionLabel",
			"progress": "c8vWKa_progress",
			"options": "c8vWKa_options",
			"footer": "c8vWKa_footer",
			"eyebrow": "c8vWKa_eyebrow",
			"title": "c8vWKa_title",
			"customInput": "c8vWKa_customInput",
			"optionLine": "c8vWKa_optionLine",
			"badge": "c8vWKa_badge",
			"customRowActive": "c8vWKa_customRowActive",
			"frame": "c8vWKa_frame",
			"iconButton": "c8vWKa_iconButton",
			"detail": "c8vWKa_detail",
			"option": "c8vWKa_option",
			"headingBlock": "c8vWKa_headingBlock",
			"header": "c8vWKa_header",
			"number": "c8vWKa_number",
			"feedback": "c8vWKa_feedback",
			"checkboxChecked": "c8vWKa_checkboxChecked",
			"optionSelected": "c8vWKa_optionSelected",
			"optionCopy": "c8vWKa_optionCopy",
			"footerActions": "c8vWKa_footerActions",
			"description": "c8vWKa_description",
			"customTextarea": "c8vWKa_customTextarea",
			"card": "c8vWKa_card",
			"pager": "c8vWKa_pager"
		};
		//#endregion
