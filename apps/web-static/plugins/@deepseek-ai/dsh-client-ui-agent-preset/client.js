window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetLabel.module.css.mjs
		const css$3 = ".i-TpqW_label{background:var(--dsw-alias-fill-tsp-secondary);max-width:180px;height:22px;color:var(--dsw-alias-label-secondary);white-space:nowrap;text-overflow:ellipsis;border-radius:6px;align-items:center;gap:4px;padding:0 2px 0 0;font-size:12px;line-height:22px;display:inline-flex;overflow:hidden}.i-TpqW_icon{opacity:.7;flex:none}";
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetRow.module.css.mjs
		const css$2 = ".M71vIa_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.M71vIa_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.M71vIa_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.M71vIa_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.M71vIa_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.M71vIa_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.M71vIa_selector:disabled{cursor:default}.M71vIa_chevron{flex:none}";
		...
		var AgentPresetRow_module_css_default = {
			"title": "M71vIa_title",
			"desc": "M71vIa_desc",
			"rowText": "M71vIa_rowText",
			"row": "M71vIa_row",
			"selector": "M71vIa_selector",
			"chevron": "M71vIa_chevron"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetSeat.module.css.mjs
		const css$1 = ".Xrzv0q_seat{max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex;overflow:hidden}.Xrzv0q_seat:not(:disabled):hover,.Xrzv0q_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}.Xrzv0q_seat:disabled{cursor:default;color:var(--dsw-alias-label-quaternary)}.Xrzv0q_seatIcon{color:var(--dsw-alias-label-primary);flex:none}.Xrzv0q_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both Xrzv0q_seat-icon-in}@keyframes Xrzv0q_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}.Xrzv0q_introText{white-space:pre;display:inline-block}.Xrzv0q_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards Xrzv0q_seat-char-in;display:inline-block}@keyframes Xrzv0q_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){.Xrzv0q_introIcon,.Xrzv0q_introChar{opacity:1;animation:none}}.Xrzv0q_chevron{color:var(--dsw-alias-label-caption);flex:none}.Xrzv0q_item{flex-direction:column;gap:2px;max-width:280px;display:flex}.Xrzv0q_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.Xrzv0q_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		...
		var AgentPresetSeat_module_css_default = {
			"introIcon": "Xrzv0q_introIcon",
			"chevron": "Xrzv0q_chevron",
			"itemName": "Xrzv0q_itemName",
			"seat-icon-in": "Xrzv0q_seat-icon-in",
			"seat": "Xrzv0q_seat",
			"seatIcon": "Xrzv0q_seatIcon",
			"introText": "Xrzv0q_introText",
			"introChar": "Xrzv0q_introChar",
			"seat-char-in": "Xrzv0q_seat-char-in",
			"item": "Xrzv0q_item",
			"itemDesc": "Xrzv0q_itemDesc"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\sunflowerss\Desktop\XRKbar\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetSection.module.css.mjs
		const css = ".cdAnbq_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.cdAnbq_title{margin:0;font-size:18px;font-weight:600}.cdAnbq_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.cdAnbq_group{flex-direction:column;gap:10px;display:flex}.cdAnbq_group+.cdAnbq_group{margin-top:20px}.cdAnbq_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.cdAnbq_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.cdAnbq_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.cdAnbq_card:hover:not(.cdAnbq_cardActive){border-color:var(--dsw-alias-label-dimmed)}.cdAnbq_cardActive{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-primary)}.cdAnbq_cardBroken,.cdAnbq_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.cdAnbq_brokenBadge{white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.cdAnbq_cardBrokenReason{color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;font-size:12px;line-height:1.5}.cdAnbq_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.cdAnbq_cardMain:disabled{cursor:default}.cdAnbq_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.cdAnbq_cardHead{align-items:center;gap:8px;display:flex}.cdAnbq_cardName{font-size:15px;font-weight:600;line-height:1.4}.cdAnbq_badge,.cdAnbq_inUse{white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.cdAnbq_badge{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary)}.cdAnbq_inUse{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);margin-left:auto}.cdAnbq_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.cdAnbq_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-dimmed);margin-top:auto;font-size:11px}.cdAnbq_cardFoot{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.cdAnbq_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.cdAnbq_iconButton:disabled{opacity:.4;cursor:default}.cdAnbq_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.cdAnbq_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.cdAnbq_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.cdAnbq_iconButton:hover:after,.cdAnbq_iconButton:focus-visible:after{opacity:1}.cdAnbq_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.cdAnbq_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.cdAnbq_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.cdAnbq_revealedPathLabel{white-space:nowrap}.cdAnbq_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.cdAnbq_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.cdAnbq_secondaryButton:disabled{opacity:.5;cursor:default}.cdAnbq_field{flex-direction:column;gap:6px;display:flex}.cdAnbq_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.cdAnbq_input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.cdAnbq_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.cdAnbq_input::placeholder{color:var(--dsw-alias-label-dimmed)}.cdAnbq_dialog{width:min(560px,100%)}.cdAnbq_dialogFields{flex-direction:column;gap:12px;display:flex}.cdAnbq_viewerCode{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.cdAnbq_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.cdAnbq_deleteDialog{width:min(480px,100%)}.cdAnbq_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.cdAnbq_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.cdAnbq_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:12px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.cdAnbq_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.cdAnbq_creatorButton:disabled{opacity:.4;cursor:default}";
		...
		var AgentPresetSection_module_css_default = {
			"secondaryButton": "cdAnbq_secondaryButton",
			"cards": "cdAnbq_cards",
			"brokenBadge": "cdAnbq_brokenBadge",
			"cardId": "cdAnbq_cardId",
			"field": "cdAnbq_field",
			"groupHead": "cdAnbq_groupHead",
			"cardBroken": "cdAnbq_cardBroken",
			"title": "cdAnbq_title",
			"inUse": "cdAnbq_inUse",
			"intro": "cdAnbq_intro",
			"deleteConfirm": "cdAnbq_deleteConfirm",
			"creatorButton": "cdAnbq_creatorButton",
			"iconDanger": "cdAnbq_iconDanger",
			"cardDesc": "cdAnbq_cardDesc",
			"iconButton": "cdAnbq_iconButton",
			"cardActive": "cdAnbq_cardActive",
			"input": "cdAnbq_input",
			"cardMain": "cdAnbq_cardMain",
			"cardBrokenReason": "cdAnbq_cardBrokenReason",
			"fieldLabel": "cdAnbq_fieldLabel",
			"card": "cdAnbq_card",
			"error": "cdAnbq_error",
			"group": "cdAnbq_group",
			"cardFoot": "cdAnbq_cardFoot",
			"section": "cdAnbq_section",
			"dialog": "cdAnbq_dialog",
			"cardName": "cdAnbq_cardName",
			"dialogFields": "cdAnbq_dialogFields",
			"badge": "cdAnbq_badge",
			"revealedPath": "cdAnbq_revealedPath",
			"revealedPathLabel": "cdAnbq_revealedPathLabel",
			"cardHead": "cdAnbq_cardHead",
			"viewerCode": "cdAnbq_viewerCode",
			"deleteDialog": "cdAnbq_deleteDialog"
		};
		//#endregion
