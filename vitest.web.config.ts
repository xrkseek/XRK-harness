...
export default defineConfig({
  ...
  test: {
    include: [
      ...
      "apps/web/tests/product-shell-reconnect.e2e.ts",
      "apps/web/tests/product-shell-scroll.e2e.ts",
      "apps/web/tests/product-shell-file-upload-sidebar.e2e.ts",
      "apps/web/tests/product-shell-subagent-queue.e2e.ts",
    ],
    globals: false,
    pool: "forks",
    testTimeout: 60_000,
