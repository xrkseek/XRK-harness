...
**Relational companion** (`./invariant`): turn/step enclosure and tool call/result pairing for Face/Host fail-fast (`XRK_INVARIANTS_FAIL_FAST`). Registry: `@xrkseek/runtime-invariants`.
