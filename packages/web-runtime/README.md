...
规格入口：[docs/host-face.md](../../docs/host-face.md) · [docs/status.md](../../docs/status.md)。本包是 `apps/console` 验证台算法，**不是**产品聊天壳（壳源码 `apps/web` + `packages/client`；serve 用 `apps/web/dist`）。
