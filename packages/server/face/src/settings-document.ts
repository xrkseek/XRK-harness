...
function resolveCredentialSlotForRef(
  ...
  if (ref === "XRK_IMAGE_GEN_FAL_KEY") return "image.fal";
  if (ref === "XRK_IMAGE_GEN_XAI_KEY") return "image.xai";
  if (ref === "XRK_IMAGE_GEN_OPENROUTER_KEY") return "image.openrouter";
  if (ref === "XRK_IMAGE_GEN_DEEPINFRA_KEY") return "image.deepinfra";
  if (ref === "XRK_IMAGE_GEN_KREA_KEY") return "image.krea";
  if (ref === "XRK_IMAGE_GEN_META_KEY") return "image.meta-ai";
  if (ref === "XRK_VIDEO_GEN_OPENAI_KEY") return "video.openai";
  if (ref === "XRK_VIDEO_GEN_FAL_KEY") return "video.fal";
  if (ref === "XRK_VIDEO_GEN_XAI_KEY") return "video.xai";
  if (ref === "XRK_VIDEO_GEN_OPENROUTER_KEY") return "video.openrouter";
  if (ref === "XRK_VIDEO_GEN_DEEPINFRA_KEY") return "video.deepinfra";
...
function credentialRefForSlot(
  ...
  if (slotId === "image.fal") return "XRK_IMAGE_GEN_FAL_KEY";
  if (slotId === "image.xai") return "XRK_IMAGE_GEN_XAI_KEY";
  if (slotId === "image.openrouter") return "XRK_IMAGE_GEN_OPENROUTER_KEY";
  if (slotId === "image.deepinfra") return "XRK_IMAGE_GEN_DEEPINFRA_KEY";
  if (slotId === "image.krea") return "XRK_IMAGE_GEN_KREA_KEY";
  if (slotId === "image.meta-ai") return "XRK_IMAGE_GEN_META_KEY";
  if (slotId === "video.openai") return "XRK_VIDEO_GEN_OPENAI_KEY";
  if (slotId === "video.fal") return "XRK_VIDEO_GEN_FAL_KEY";
  if (slotId === "video.xai") return "XRK_VIDEO_GEN_XAI_KEY";
  if (slotId === "video.openrouter") return "XRK_VIDEO_GEN_OPENROUTER_KEY";
  if (slotId === "video.deepinfra") return "XRK_VIDEO_GEN_DEEPINFRA_KEY";
