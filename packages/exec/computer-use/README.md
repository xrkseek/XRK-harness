...
Delivery on Windows UIA is **uia**, not cua-driver background SPI. Tools stay registered when no Provider is configured; execute fails honestly (same pattern as LSP).
