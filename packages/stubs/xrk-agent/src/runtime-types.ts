 ...
 * turn/step boundaries remain `@xrkseek/xrk-session` events.
 *
...
import type { LlmCallConfig, LlmFailure, ResolvedRetryPolicy } from '@xrkseek/xrk-llm'
import type { AgentCancelCause, Session, SessionId, UserMessage } from '@xrkseek/xrk-session'
export type { AgentCancelCause } from '@xrkseek/xrk-session'
import type { Inbox } from './inbox.ts'
import type { InboxTarget } from './types.ts'
import type {} from '@xrkseek/xrk-system-prompt'
declare module '@xrkseek/xrk-system-prompt' {
...
declare module '@xrkseek/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@xrkseek/xrk-scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */
