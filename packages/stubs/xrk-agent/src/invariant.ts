/** Package-owned agent lifecycle invariants. @module @xrkseek/xrk-agent/invariant */

import type { Context } from '@xrkseek/cordis'
import type { InvariantInstaller } from '@xrkseek/xrk-invariants'
import type { Agent, AgentStatus } from '@xrkseek/xrk-agent'

const PACKAGE_NAME = '@xrkseek/xrk-agent'
