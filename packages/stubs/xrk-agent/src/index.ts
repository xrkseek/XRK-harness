...
import { scopeTarget } from '@xrkseek/xrk-scope'
import type { Scoped } from '@xrkseek/xrk-scope'
import type { SessionEvent, SessionId } from '@xrkseek/xrk-session'
import type { TypertContext, TypertLookup } from '@xrkseek/xrk-typert-protocol'
 ...
 * (`@xrkseek/xrk-agent-loop`), registered via {@link setFactory}.
 *
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('agent', {
        parameter: 'agent',
        wire: 'agentId',
        hostTypeSymbol: '@xrkseek/xrk-agent#Agent',
