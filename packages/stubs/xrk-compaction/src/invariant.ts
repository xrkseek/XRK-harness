/** Package-owned compaction log-stream invariants. @module @xrkseek/xrk-compaction/invariant */

import type { Context } from '@xrkseek/cordis'
import { isReplacementSurfaceEvent } from '@xrkseek/xrk-session'
...
const PACKAGE_NAME = '@xrkseek/xrk-compaction'
