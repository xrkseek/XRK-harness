 ...
 *
 * The seam itself lives in `@xrkseek/xrk-compaction`, which re-exports these
 ...
 *
 * @module @xrkseek/xrk-compaction/checkpoint
 */

import type { MessageSource } from '@xrkseek/xrk-llm/message'
