...
import type { Session, SessionEvent } from '@xrkseek/xrk-session'
import type { SandboxMode } from '@xrkseek/xrk-sandbox'
import { SANDBOX_MODES, effectiveSandboxMode, setSandboxMode } from '@xrkseek/xrk-sandbox-policy'
...
import type {} from '@xrkseek/xrk-shell'
import type { ApprovalPolicy } from '@xrkseek/xrk-user-approval'
import { APPROVAL_POLICIES, effectiveApprovalPolicy, setApprovalPolicy } from '@xrkseek/xrk-user-approval'
import { installSettingsSection, settingsNamespace } from '@xrkseek/xrk-settings'
...
declare module '@xrkseek/xrk-session/types' {
