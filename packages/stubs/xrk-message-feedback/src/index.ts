 ...
 * @module @xrkseek/xrk-message-feedback
 */

import { Buffer } from 'node:buffer'
import { randomUUID } from 'node:crypto'
import { Context, Service } from '@xrkseek/cordis'
import s from '@xrkseek/schemastery'
import { deriveEventMessage, isAppendSurfaceEvent } from '@xrkseek/xrk-session/surface'
import type { SessionHeader, SessionId } from '@xrkseek/xrk-session/types'
import type { SessionInspection } from '@xrkseek/xrk-session-persistence'
import type { KvTable } from '@xrkseek/xrk-storage-domain'
import { TypertRemoteService, Remote } from '@xrkseek/xrk-typert-protocol'
