 ...
 * @module @xrkseek/xrk-session-title
 */

import { Context, FiberState, Service, type Fiber } from '@xrkseek/cordis'
import z from '@xrkseek/schemastery'
import { z as zod } from 'zod'
import type { Branded } from '@xrkseek/xrk-brand'
import { assertNever, deepFreeze, isAgentLoopRequest } from '@xrkseek/xrk-llm'
import type { GenerateOptions } from '@xrkseek/xrk-llm'
import type {
  Session,
  SessionEvent,
