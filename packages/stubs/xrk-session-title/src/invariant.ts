/**
 * Package-owned invariant companion for `@xrkseek/xrk-session-title`.
 * @module @xrkseek/xrk-session-title/invariant
 */

/* jscpd:ignore-start */
import type { Context } from '@xrkseek/cordis'
import type { InvariantFailure, InvariantInstaller } from '@xrkseek/xrk-invariants'
import type { SessionEvent } from '@xrkseek/xrk-session'

const PACKAGE_NAME = '@xrkseek/xrk-session-title'
