/**
 * Package-owned invariant companion for `@xrkseek/xrk-session-projection`.
 * @module @xrkseek/xrk-session-projection/invariant
 */
...
const PACKAGE_NAME = '@xrkseek/xrk-session-projection'
