...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('policy-denied'), message: z.string(), details: z.object({ kind: z.string(), reason: z.string(), ruleId: z.string().optional() }) }),
  z.object({ code: z.literal('policy-ask'), message: z.string(), details: z.object({ kind: z.string(), reason: z.string(), ruleId: z.string().optional() }) }),
