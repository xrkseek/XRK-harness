/**
 * @xrkseek/xrk-host-apiproxy — the API gateway every client shape shares:
...
import type {} from '@xrkseek/xrk-agent-default-model'
...
export class ApiProxyService extends Service implements ApiProxy {
  ...
  readonly mcpOauth: ApiProxy['mcpOauth']
