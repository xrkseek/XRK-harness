/** Package-owned durable retry-event invariants. @module @xrkseek/xrk-llm-retry/invariant */

import type { Context } from '@xrkseek/cordis'
import type { Session, SessionEvent } from '@xrkseek/xrk-session'
import type { LlmFailure } from '@xrkseek/xrk-llm'
import { MAX_TIMER_DELAY_MS } from '@xrkseek/xrk-timeout'
import type { InvariantFailure, InvariantInstaller } from '@xrkseek/xrk-invariants'
import { providerForOpenStep } from './history.ts'
import type {} from './index.ts'

const PACKAGE_NAME = '@xrkseek/xrk-llm-retry'
