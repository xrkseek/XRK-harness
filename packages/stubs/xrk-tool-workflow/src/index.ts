 ...
 * (`@xrkseek/xrk-workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module @xrkseek/xrk-tool-workflow
 */

import type { Context } from '@xrkseek/cordis'
import z from '@xrkseek/schemastery'
import { defineTool } from '@xrkseek/xrk-tools'
import type { ToolCallView, ToolResultView } from '@xrkseek/xrk-tools'
import type { ContentBlock } from '@xrkseek/xrk-llm'
import type { JsonValue, Session, SessionEventMap } from '@xrkseek/xrk-session'
import type {
