 ...
 * companion beside `@xrkseek/xrk-invariants` to enable the checks.
 *
 * @module @xrkseek/xrk-session/invariant
 */

import type { Context } from '@xrkseek/cordis'
import { assertNever } from '@xrkseek/xrk-llm'
import type { CallId } from '@xrkseek/xrk-llm'
...
const PACKAGE_NAME = '@xrkseek/xrk-session'
