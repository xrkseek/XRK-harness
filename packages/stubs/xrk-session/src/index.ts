 ...
 *
 * @module @xrkseek/xrk-session
 */

import { Context, Service } from '@xrkseek/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@xrkseek/xrk-llm'
import { scopeOf, scopeTarget } from '@xrkseek/xrk-scope'
import type { Scoped } from '@xrkseek/xrk-scope'
import type { Message } from '@xrkseek/xrk-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@xrkseek/xrk-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@xrkseek/xrk-llm'
...
declare module '@xrkseek/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@xrkseek/xrk-scope`): agent-scoped listeners
     ...
     * Scope-filtered dispatch (`@xrkseek/xrk-scope`) reuses the owner scope.
     ...
     * (`@xrkseek/xrk-scope`) reuses the session's owner scope.
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@xrkseek/xrk-session#Session',
        wireTypeSymbol: '@xrkseek/xrk-session/types#SessionId',
