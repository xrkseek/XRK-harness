 ...
 *
 * @module @xrkseek/xrk-token-meter/surface-projection
 */

import { deriveEventMessage, isSurfaceEvent } from '@xrkseek/xrk-session'
import type { SessionEvent } from '@xrkseek/xrk-session'
// Type-only: the `compaction/*` SessionEventMap merges (shadow-price events).
import type {} from '@xrkseek/xrk-compaction'
