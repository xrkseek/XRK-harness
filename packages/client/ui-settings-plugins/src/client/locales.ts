...
export const en: Record<PluginsSettingsLocaleKey, string> = {
  ...
  imageGenDescription: 'image_generate: text-to-image and image-to-image / reference edit (URLs / attachment ids; schema from Provider capabilities). API key via Credentials. Set XRK_IMAGE_GEN in CI to bypass this card.',
  imageGenMode: 'Mode',
  ...
  videoGenDescription: 'video_generate: text-to-video, image-to-video / first frame, edit/extend, and family catalog (schema from Provider capabilities). API key via Credentials. Set XRK_VIDEO_GEN in CI to bypass this card.',
  videoGenMode: 'Mode',
...
export const zh: Record<PluginsSettingsLocaleKey, string> = {
  ...
  imageGenTitle: '图像生成',
  imageGenDescription: 'image_generate：文生图 + 图生图/参考编辑（URL / 附件 id；schema 按 Provider capabilities 动态重建）。密钥经凭据落盘。CI 可设 XRK_IMAGE_GEN 旁路本卡。',
  imageGenMode: '模式',
  ...
  videoGenTitle: '视频生成',
  videoGenDescription: 'video_generate：文生视频 + 图生视频/首帧 + edit/extend + family catalog（schema 按 Provider capabilities 动态重建）。密钥经凭据落盘。CI 可设 XRK_VIDEO_GEN 旁路本卡。',
  videoGenMode: '模式',
