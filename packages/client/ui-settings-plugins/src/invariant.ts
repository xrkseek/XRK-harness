/**
 * Package-owned invariant companion for `@xrkseek/client-ui-settings-plugins`.
 * @module @xrkseek/client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@xrkseek/client-ui-settings-plugins'
