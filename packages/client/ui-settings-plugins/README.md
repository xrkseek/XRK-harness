...
The cards this package ships cover MCP servers (`mcp`), the shell executor (`bash`), the agent loop (`agent-loop`), web search (`web-search`, keys via Credentials), and workspace-inject limits (`workspace-inject`).
