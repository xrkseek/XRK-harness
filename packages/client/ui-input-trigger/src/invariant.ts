/**
 * Package-owned invariant companion for `@xrkseek/client-ui-input-trigger`.
 * @module @xrkseek/client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@xrkseek/client-ui-input-trigger'
