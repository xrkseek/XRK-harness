...
export const zh = {
  ...
  'input.stop': '停止生成',
  'input.send': '发送消息',
  'input.send.queue': '排队（本轮后）',
  'input.send.steer': '插队（本轮内）',
  'input.send.queue.hint': '等当前轮结束后再答（排队）',
  'input.send.steer.hint': '在下一工具/步边界切入当前轮（插队，不等于停止）',
  'placeholder.steerQueue': 'Cmd/Ctrl+Enter 插队发送全部排队消息',
  'placeholder.busyQueue': 'Enter 排队 · Cmd/Ctrl+Enter 插队',
  'placeholder.busySteer': 'Enter 插队 · Cmd/Ctrl+Enter 排队',
  'input.accessMode': '访问模式，当前：{name}',
  'image.dropTitle': '附件拖动到此处即可添加',
  'image.dropDesc': '最多 {count} 个，每个 {size}',
  ...
  'settings.enter.description': '智能体运行时：排队=等本轮结束后再答；插队=在工具/步边界切入当前轮（不等于停止）。Enter 与发送按钮用所选行为，Cmd/Ctrl+Enter 用另一行为',
  'settings.enter.queue': '排队',
  'settings.enter.steer': '插队',
  'access.confirm.title': '确认启用完全访问？',
  'access.confirm.description': '完全访问会关闭审批提示，且不再对 shell/PTY 套工作区沙箱。文件工具（write_file 等）仍不能写出工作区根。仅在你信任当前任务时使用。',
  'access.confirm.acknowledge': '我已了解风险，并愿意继续',
  'access.confirm.cancel': '取消',
  'access.confirm.enable': '启用完全访问',
  'access.preset.read-only': '只读',
  'access.preset.workspace-write': '工作区写入',
  'access.preset.danger-full-access': '完全访问',
  'access.desc.read-only': '仅允许读工具；禁止写入、bash 与会改状态的终端操作。',
  'access.desc.workspace-write': '可在工作区内写入；shell 受沙箱约束；越界操作需审批。',
  'access.desc.danger-full-access': '无审批提示；shell 不再套沙箱。文件工具仍不能离开工作区根。',
  ...
  'message.context.fragment.identity': '{fragmentKind} · {fragmentId}',
  'message.context.fragment.kind': '{fragmentKind}',
  ...
  'message.context.autoContinue': '已自动继续',
  ...
  'message.stopped': '已停止',
  'message.pendingSteer': '插队中',
  'message.branch': '在新对话中分支',
  'message.branchUnavailable': '仅可从已完成轮次的最后一条消息分支',
  'message.restore': '恢复工作区文件',
  'message.restoreUnavailable': '仅可从已完成轮次的最后一条消息恢复工作区',
  ...
  'message.turnTime.title': '本轮耗时',
  'message.turnTime.duration': '用时',
  'message.turnTime.speed': '吞吐',
  'message.turnTime.ttft': '首 token',
  ...
  'approval.escalationDetail': '工具 {toolName} 请求升级沙箱/权限',
  'approval.network': '请求访问网络 {protocol}://{host}',
  'approval.badge.tool': '工具',
  'approval.badge.network': '网络',
  'approval.badge.escalation': '升级权限',
  'approval.reject': '拒绝',
  ...
  'queue.remove': '删除排队消息',
  'queue.steer': '立即插队',
  'queue.steer.hint': '把这条排队消息提升进当前轮（工具/步边界）',
  'queue.steer.unavailable': '仅运行中可插队',
  'queue.steer.queued': '插队窗口已关闭，消息保留在排队中',
  'queue.editFailed': '编辑失败：这条消息可能已经开始发送。',
  'queue.removeFailed': '删除失败：这条消息可能已经开始发送。',
  'queue.steerFailed': '插队失败，请重试。',
  'queue.file': '排队文件 {name}',
  'queue.sending': '发送中…',
  'queue.image': '排队消息图片',
  'placeholder.reconnecting': '连接已断开，正在重连…',
...
export const en = {
  ...
  'input.send.queue': 'Queue (after this turn)',
  'input.send.steer': 'Steer (into this turn)',
  'input.send.queue.hint': 'Deliver after this turn finishes (queue)',
  'input.send.steer.hint': 'Inject at the next tool/step boundary (steer ≠ Stop)',
  'placeholder.steerQueue': 'Cmd/Ctrl+Enter steers all queued messages into this turn',
  'placeholder.busyQueue': 'Enter queues · Cmd/Ctrl+Enter steers',
  'placeholder.busySteer': 'Enter steers · Cmd/Ctrl+Enter queues',
  'input.accessMode': 'Access mode, current: {name}',
  'image.dropTitle': 'Drag attachments here to add them',
  'image.dropDesc': 'Up to {count} attachments, {size} each',
  ...
  'settings.enter.description': 'While the agent is running: Queue = answer after this turn; Steer = inject at the next tool/step boundary (not Stop). Enter and Send use the selected behavior; Cmd/Ctrl+Enter uses the other',
  'settings.enter.queue': 'Queue',
  'settings.enter.steer': 'Steer',
  'access.confirm.title': 'Enable Full access?',
  'access.confirm.description': 'Full access turns off approval prompts and stops wrapping shell/PTY in the workspace sandbox. File tools (write_file, etc.) still cannot leave the workspace root. Use only when you trust the current task.',
  ...
  'access.desc.read-only': 'Read tools only. Writes, bash, and mutating terminals are denied.',
  'access.desc.workspace-write': 'Write inside the workspace; shell stays confined. Wider retries need approval.',
  'access.desc.danger-full-access': 'No approval prompts; shell is not sandboxed. File tools still cannot leave the workspace root.',
  ...
  'turnStatus.0': 'Deep diving...',
  'turnStatus.1': 'Thinking...',
  'turnStatus.2': 'Pondering...',
  'turnStatus.3': 'Gathering thoughts...',
  'turnStatus.4': 'Digging in...',
  'turnStatus.5': 'Cooking...',
  'turnStatus.6': 'Working on it...',
  'turnStatus.7': 'Almost there...',
  'turnStatus.8': 'Sorting the clues...',
  'turnStatus.9': 'Checking context...',
  'turnStatus.10': 'Breaking it down...',
  'turnStatus.11': 'Weighing options...',
  'turnStatus.12': 'Checking details...',
  'turnStatus.13': 'Connecting the dots...',
  'turnStatus.14': 'Shaping a reply...',
  'turnStatus.15': 'One more pass...',
  ...
  'message.context.autoContinue': 'Auto-continued',
  ...
  'message.restore': 'Restore workspace files',
  'message.restoreUnavailable': 'Available only on the last message of a completed turn',
  ...
  'message.tokensPerSecond': '{tps} tok/s',
  'message.turnTime.title': 'Turn time',
  'message.turnTime.duration': 'Duration',
  'message.turnTime.speed': 'Speed',
  'message.turnTime.ttft': 'TTFT',
  ...
  'approval.escalationDetail': 'Tool {toolName} requests a sandbox / privilege upgrade',
  'approval.network': 'Requests network access to {protocol}://{host}',
  'approval.badge.tool': 'Tool',
  'approval.badge.network': 'Network',
  'approval.badge.escalation': 'Escalation',
  ...
  'queue.steer': 'Steer into this turn',
  'queue.steer.hint': 'Promote this queued message into the running turn (tool/step boundary)',
  'queue.steer.unavailable': 'Steering is available only while the agent is running',
  'queue.steer.queued': 'Steer window closed; message stays in the queue',
  ...
  'placeholder.reconnecting': 'Connection lost. Reconnecting…',
