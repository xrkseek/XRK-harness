/**
 * Package-owned invariant companion for `@xrkseek/client-ui-conversation`.
 * @module @xrkseek/client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@xrkseek/client-ui-conversation'
