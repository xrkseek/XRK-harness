...
export const zh = {
  ...
  'preview.intro': '文件编辑与终端在右侧工作台；此处是本会话的站立计划与模式状态。',
...
export const en = {
  ...
  'preview.intro': 'File editing and terminals live in the right workbench; this column is the standing plan and mode status for this session.',
