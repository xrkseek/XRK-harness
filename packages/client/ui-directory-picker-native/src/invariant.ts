/**
 * Package-owned invariant companion for `@xrkseek/client-ui-directory-picker-native`.
 * @module @xrkseek/client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@xrkseek/client-ui-directory-picker-native'
