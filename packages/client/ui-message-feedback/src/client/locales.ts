...
export const zh = {
  ...
  'dialog.detail': '反馈详情',
  'dialog.hint': '填写详情以帮助我们改进体验；提交时会附带当前会话日志片段',
...
declare module '@xrkseek/client-ui-slots' {
  interface LocaleNamespaceMap {
    /** Per-message controls, session dialog, and acknowledgement toast. */
...
export const en = {
  ...
  'dialog.hint': 'Add details to help us improve. Your submission includes a related conversation slice.',
