 ...
 * @module @xrkseek/client-ui-message-feedback/client/controller
 */

import type { RemoteResult } from '@xrkseek/xrk-typert-protocol'
import type { HostObservable } from '@xrkseek/client-ui-slots'
import type { MessageId, SessionId } from '@xrkseek/client-connection/client'
import type {
...
} from '@xrkseek/xrk-message-feedback/types'
