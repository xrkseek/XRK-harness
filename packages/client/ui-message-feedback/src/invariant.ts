/**
 * Package-owned invariant companion for `@xrkseek/client-ui-message-feedback`.
 * @module @xrkseek/client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@xrkseek/client-ui-message-feedback'
