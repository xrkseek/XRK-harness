/**
 * Package-owned invariant companion for `@xrkseek/client-ui-settings-general`.
 * @module @xrkseek/client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@xrkseek/client-ui-settings-general'
