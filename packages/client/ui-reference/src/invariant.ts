/**
 * Package-owned invariant companion for `@xrkseek/client-ui-reference`.
 * @module @xrkseek/client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@xrkseek/client-ui-reference'
