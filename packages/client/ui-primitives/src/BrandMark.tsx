/**
 * XRK mark — paths traced from `apps/web/public/logo-plate.png` (vectorizer).
 * Do not hand-edit the petal geometry; re-trace from the plate PNG instead.
 */
...
/**
 * Render the XRK sunflower mark.
 * @param props.size - width/height in px (square; default 24).
