...
// plain fallback for everything else. Supported blocks stay plain until the
// first viewport intersection ({@link useViewportHighlighting}); streaming
// fences highlight incrementally through {@link StreamingHighlightSession}.
...
export function CodeBlock({
  code, lang, streaming, className, copyLabel = '复制', copiedLabel = '复制成功',
}: CodeBlockProps) {
