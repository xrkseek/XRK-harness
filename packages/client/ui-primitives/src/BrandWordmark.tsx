/**
 * XRK Harness wordmark: plate-traced mark + XRK lettering + HARNESS badge.
 * Mark paths traced from `apps/web/public/logo-plate.png` (vectorizer).
 */
import type { IconProps } from './icons/props.ts'

const MARK = 348
/** Mark column + gap + lettering + gap + badge. */
const WORD_W = 168
const WORD_H = 28

/**
 * Render the full brand wordmark.
 * @param props.size - height in px (default 24; width keeps the wordmark ratio).
...
export function BrandWordmark({ size = 24, className }: IconProps) {
  return (
    ...
    >
      ...
      <rect x="72" y="6" width="92" height="16" rx="2" fill="currentColor" />
      <text
        x="118"
        y="17.5"
