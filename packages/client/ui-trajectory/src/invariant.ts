/**
 * Package-owned invariant companion for `@xrkseek/client-ui-trajectory`.
 * @module @xrkseek/client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@xrkseek/client-ui-trajectory'
