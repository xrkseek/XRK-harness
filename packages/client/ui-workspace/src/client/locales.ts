...
export const zh = {
  ...
  'archiveView.label': '归档显示',
  'archiveView.hidden': '隐藏已归档',
  'archiveView.all': '全部会话',
  'archiveView.archivedOnly': '仅已归档',
...
export const en = {
  ...
  'archiveView.label': 'Archived sessions',
  'archiveView.hidden': 'Hide archived',
  'archiveView.all': 'All sessions',
  'archiveView.archivedOnly': 'Archived only',
