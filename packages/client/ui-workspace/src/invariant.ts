/**
 * Package-owned invariant companion for `@xrkseek/client-ui-workspace`.
 * @module @xrkseek/client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@xrkseek/client-ui-workspace'
