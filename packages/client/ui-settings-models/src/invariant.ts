/**
 * Package-owned invariant companion for `@xrkseek/client-ui-settings-models`.
 * @module @xrkseek/client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@xrkseek/client-ui-settings-models'
