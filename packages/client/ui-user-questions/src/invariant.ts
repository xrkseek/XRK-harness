/**
 * Package-owned invariant companion for `@xrkseek/client-ui-user-questions`.
 * @module @xrkseek/client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@xrkseek/client-ui-user-questions'
