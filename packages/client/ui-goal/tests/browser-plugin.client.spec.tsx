...
import { SlotRegistry, type SessionId } from '@xrkseek/client-runtime/client'
import { ConversationEventRegistry } from '@xrkseek/client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@xrkseek/xrk-goal/client'
