/**
 * Package-owned invariant companion for `@xrkseek/client-ui-deliverables`.
 * @module @xrkseek/client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@xrkseek/client-ui-deliverables'
