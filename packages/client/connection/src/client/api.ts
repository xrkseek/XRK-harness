...
export { AbstractApiClient } from '@xrkseek/xrk-host-apiproxy/client'
export type { IApiClient } from '@xrkseek/xrk-host-apiproxy/client'
export type { SessionId, SessionEvent } from '@xrkseek/xrk-session/types'
export type { MessageId } from '@xrkseek/xrk-llm/brand'
export type { ContentBlock, StreamChunk } from '@xrkseek/xrk-llm/types'

/** Successful value returned by the connection-generation host handshake. */
export type HostDescription = import('@xrkseek/xrk-host-apiproxy/api').ResponseValue<'host.describe'>

import type { RpcResponse, RpcResult } from '@xrkseek/xrk-host-apiproxy/api'
