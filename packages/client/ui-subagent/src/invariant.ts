/**
 * Package-owned invariant companion for `@xrkseek/client-ui-subagent`.
 * @module @xrkseek/client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@xrkseek/client-ui-subagent'
