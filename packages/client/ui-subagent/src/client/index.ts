/**
 * Subagent browser plugin: header lineage navigation and read-only composer for
 * addressed sessions. The unified `@` reference source lives in ui-reference.
 */
import type {
  ClientContext, SessionId, SubagentAddress,
} from '@xrkseek/client-runtime/client'
import type { ComposerChainProps } from '@xrkseek/client-ui-conversation/client'
...
/**
 * Client plugin body: register lineage and read-only composer seats.
