...
import { IconChevronLeftOutline14, IconChevronRightOutline14 } from '@xrkseek/client-ui-primitives'
import css from './AttachmentRail.module.css'

/** Minimal rail item; rendering is delegated to `renderItem`. */
...
/**
 * Horizontal attachment rail over the caller's draft items.
 *
 ...
 * over an existing draft keeps its start position. The owner decides mounting
 * and supplies per-item presentation through `renderItem`.
 *
 * @param props.items - draft attachments in input order.
 * @param props.labels - rail-level strings (group name, arrow labels).
 * @param props.renderItem - render one attachment card for the rail.
