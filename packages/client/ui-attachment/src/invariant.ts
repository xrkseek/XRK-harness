/**
 * Package-owned invariant companion for `@xrkseek/client-ui-attachment`.
 * @module @xrkseek/client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@xrkseek/client-ui-attachment'
