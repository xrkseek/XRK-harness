/**
 * Package-owned invariant companion for `@xrkseek/client-runtime`.
 * @module @xrkseek/client-runtime/invariant
 */
...
import type { SlotMap } from '@xrkseek/client-ui-slots'
import type { InvariantInstaller } from '@xrkseek/xrk-invariants'

const PACKAGE_NAME = '@xrkseek/client-runtime'
