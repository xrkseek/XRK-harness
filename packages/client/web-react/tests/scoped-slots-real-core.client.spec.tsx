...
import { SlotCore, type PropsRenderSlots, type SlotRendererHost } from '@xrkseek/client-ui-slots'
import { createSlotRenderer, StaleAuthorizationError } from '@xrkseek/client-web-react'
