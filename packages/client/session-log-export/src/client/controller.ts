...
import { createSnapshotStore, type SessionId, type SnapshotStore } from '@xrkseek/client-runtime/client'
...
function hostBase(): string {
  ...
  return origin !== undefined && origin !== 'null' ? origin : 'http://xrk.internal'
}
