...
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@xrkseek/client-ui-theme/client'
import { apply, inject, LayoutController } from '@xrkseek/client-ui-layout/client'
import { apply as nodeApply } from '@xrkseek/client-ui-layout'
import * as invariant from '@xrkseek/client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@xrkseek/client-ui-layout', expect.any(Function))
