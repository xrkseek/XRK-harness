 ...
 *
 * @module @xrkseek/xrk-session-reference
 */

import { Context } from '@xrkseek/cordis'
import z from '@xrkseek/schemastery'
import type { Agent, PreStepDecision } from '@xrkseek/xrk-agent'
import { Remote, TypertRemoteService } from '@xrkseek/xrk-typert-protocol'
import { createUserMessage, freezeMessage } from '@xrkseek/xrk-llm'
import type { ContentBlock, UserMessage } from '@xrkseek/xrk-llm'
import type { SessionId } from '@xrkseek/xrk-session'
import type { SessionSurfaceSnapshot, SessionTitleObservationResult } from '@xrkseek/xrk-session-query'
import {
