/**
 * Package-owned invariant companion for `@xrkseek/xrk-file-reference`.
 * @module @xrkseek/xrk-file-reference/invariant
 */
...
const PACKAGE_NAME = '@xrkseek/xrk-file-reference'
