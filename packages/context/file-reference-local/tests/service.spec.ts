...
import AgentRegistry from '@xrkseek/xrk-agent'
import type { Agent } from '@xrkseek/xrk-agent'
import SessionStore, { SessionId } from '@xrkseek/xrk-session'
import SystemPrompt, { renderPrompt } from '@xrkseek/xrk-system-prompt'
import ToolRegistry, { defineContentToolFixture } from '@xrkseek/xrk-tools'
import { FILE_REFERENCE_PROMPT } from '@xrkseek/xrk-file-reference'
