/**
 * Package-owned invariant companion for `@xrkseek/xrk-file-reference-local`.
 * @module @xrkseek/xrk-file-reference-local/invariant
 */
...
const PACKAGE_NAME = '@xrkseek/xrk-file-reference-local'
