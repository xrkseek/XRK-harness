...
[入门](./docs/getting-started.md) · [配置](./docs/configuration.md) · [能力矩阵](./docs/status.md) · [文档中心](./docs/README.md) · [v0.1.21 发行说明](./docs/releases/v0.1.21.md)
...
| 对外 CLI 包 `@xrkseek/harness-cli` | **能跑**（**v0.1.21**；主 bin **`xrkh`**，亦 **`xrk-harness`**） |
...
| 版本发行说明 | [releases](./docs/releases/)（正式 [v0.1.21](./docs/releases/v0.1.21.md) · 预览 [v0.0.11](./docs/releases/v0.0.11.md)） |
...
| Public CLI package `@xrkseek/harness-cli` | **Working** (**v0.1.21**; primary bin **`xrkh`**, also **`xrk-harness`**) |
...
| Release notes | [releases](./docs/releases/) (formal [v0.1.21](./docs/releases/v0.1.21.md) · preview [v0.0.11](./docs/releases/v0.0.11.md)) |
