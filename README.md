...
[入门](./docs/getting-started.md) · [配置](./docs/configuration.md) · [能力矩阵](./docs/status.md) · [文档中心](./docs/README.md) · [v0.2.1 发行说明](./docs/releases/v0.2.1.md)
...
| 对外 CLI 包 `@xrkseek/harness-cli` | **能跑**（**v0.2.1**；主 bin **`xrkh`**，亦 **`xrk-harness`**） |
...
| 版本发行说明 | [releases](./docs/releases/)（当前 [v0.2.1](./docs/releases/v0.2.1.md) · 上一正式 [v0.1.31](./docs/releases/v0.1.31.md)） |
...
[Getting started](./docs/getting-started.md) · [Configuration](./docs/configuration.md) · [Status](./docs/status.md) · [Docs hub](./docs/README.md) · [v0.2.1 release notes](./docs/releases/v0.2.1.md)
...
| Public CLI package `@xrkseek/harness-cli` | **Working** (**v0.2.1**; primary bin **`xrkh`**, also **`xrk-harness`**) |
...
| Release notes | [releases](./docs/releases/) (current [v0.2.1](./docs/releases/v0.2.1.md) · previous formal [v0.1.31](./docs/releases/v0.1.31.md)) |
