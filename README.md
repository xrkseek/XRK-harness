...
预览线（本版）：`npm install -g @xrkseek/harness-cli@0.4.0-rc.3`。正式线仍是 v0.3.11，`@latest` 不被 rc 顶替。
...
| 对外 CLI 包 `@xrkseek/harness-cli` | **能跑**（正式 **v0.3.11** · 预览 **v0.4.0-rc.3**；主 bin **`xrkh`**，亦 **`xrk-harness`**） |
...
| 版本发行说明 | [releases](./docs/releases/)（正式当前 [v0.3.11](./docs/releases/v0.3.11.md) · 预览当前 [v0.4.0-rc.3](./docs/releases/v0.4.0-rc.3.md) · 上一轮预览末号 [v0.2.7](./docs/releases/v0.2.7.md)） |
...
Preview line (this release): `npm install -g @xrkseek/harness-cli@0.4.0-rc.3`. The formal line stays v0.3.11 — an rc never moves `@latest`.
