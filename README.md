...
预览线（本版）：`npm install -g @xrkseek/harness-cli@0.4.0-rc.2`。正式线仍是 v0.3.11，`@latest` 不被 rc 顶替。
...
| 对外 CLI 包 `@xrkseek/harness-cli` | **能跑**（正式 **v0.3.11** · 预览 **v0.4.0-rc.2**；主 bin **`xrkh`**，亦 **`xrk-harness`**） |
...
| 版本发行说明 | [releases](./docs/releases/)（正式当前 [v0.3.11](./docs/releases/v0.3.11.md) · 预览当前 [v0.4.0-rc.2](./docs/releases/v0.4.0-rc.2.md) · 上一轮预览末号 [v0.2.7](./docs/releases/v0.2.7.md)） |
...
Preview line (this release): `npm install -g @xrkseek/harness-cli@0.4.0-rc.2`. The formal line stays v0.3.11 — an rc never moves `@latest`.
...
| Public CLI package `@xrkseek/harness-cli` | **Working** (formal **v0.3.11** · preview **v0.4.0-rc.2**; primary bin **`xrkh`**, also **`xrk-harness`**) |
...
| Release notes | [releases](./docs/releases/) (formal current [v0.3.11](./docs/releases/v0.3.11.md) · preview current [v0.4.0-rc.2](./docs/releases/v0.4.0-rc.2.md) · previous preview line end [v0.2.7](./docs/releases/v0.2.7.md)) |
