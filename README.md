...
[入门](./docs/getting-started.md) · [配置](./docs/configuration.md) · [能力矩阵](./docs/status.md) · [文档中心](./docs/README.md) · [v0.4.5 发行说明](./docs/releases/v0.4.5.md)
...
npm install -g @xrkseek/harness-cli@0.4.5
xrkh web
```

`@latest` 即本版（v0.4.5）。`MINOR=4` 预览线在 v0.4.0 收口：过程号 `0.4.0-rc.1`–`rc.4` 已并入，不再单独安装；上一正式线 `0.3.11` 仍可精确安装。
...
| 对外 CLI 包 `@xrkseek/harness-cli` | **能跑**（当前 **v0.4.5** = `@latest`；主 bin **`xrkh`**，亦 **`xrk-harness`**） |
...
| 版本发行说明 | [releases](./docs/releases/)（当前 [v0.4.5](./docs/releases/v0.4.5.md) = `@latest` · 上一补丁 [v0.4.4](./docs/releases/v0.4.4.md) · 上一正式线 [v0.3.11](./docs/releases/v0.3.11.md) · 上一轮预览末号 [v0.2.7](./docs/releases/v0.2.7.md)） |
...
[Getting started](./docs/getting-started.md) · [Configuration](./docs/configuration.md) · [Status](./docs/status.md) · [Docs hub](./docs/README.md) · [v0.4.5 release notes](./docs/releases/v0.4.5.md)
...
`@latest` resolves here (v0.4.5). The `MINOR=4` preview line closed at v0.4.0: process builds `0.4.0-rc.1`–`rc.4` are folded in and no longer installed separately; the previous formal line `0.3.11` remains installable by exact pin.
...
| Public CLI package `@xrkseek/harness-cli` | **Working** (current **v0.4.5** = `@latest`; primary bin **`xrkh`**, also **`xrk-harness`**) |
...
| Release notes | [releases](./docs/releases/) (current [v0.4.5](./docs/releases/v0.4.5.md) = `@latest` · previous patch [v0.4.4](./docs/releases/v0.4.4.md) · previous formal line [v0.3.11](./docs/releases/v0.3.11.md) · previous preview line end [v0.2.7](./docs/releases/v0.2.7.md)) |
