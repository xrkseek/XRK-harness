...
[入门](./docs/getting-started.md) · [配置](./docs/configuration.md) · [能力矩阵](./docs/status.md) · [文档中心](./docs/README.md) · [v0.3.10 发行说明](./docs/releases/v0.3.10.md)
...
| 对外 CLI 包 `@xrkseek/harness-cli` | **能跑**（**v0.3.10**；主 bin **`xrkh`**，亦 **`xrk-harness`**） |
...
| 版本发行说明 | [releases](./docs/releases/)（当前 [v0.3.10](./docs/releases/v0.3.10.md) · 预览末号 [v0.2.7](./docs/releases/v0.2.7.md)） |
...
[Getting started](./docs/getting-started.md) · [Configuration](./docs/configuration.md) · [Status](./docs/status.md) · [Docs hub](./docs/README.md) · [v0.3.10 release notes](./docs/releases/v0.3.10.md)
...
| Public CLI package `@xrkseek/harness-cli` | **Working** (**v0.3.10**; primary bin **`xrkh`**, also **`xrk-harness`**) |
...
| Release notes | [releases](./docs/releases/) (current [v0.3.10](./docs/releases/v0.3.10.md) · last preview [v0.2.7](./docs/releases/v0.2.7.md)) |
