...
[入门](./docs/getting-started.md) · [配置](./docs/configuration.md) · [能力矩阵](./docs/status.md) · [文档中心](./docs/README.md) · [v0.3.0 发行说明](./docs/releases/v0.3.0.md)
...
| 对外 CLI 包 `@xrkseek/harness-cli` | **能跑**（**v0.3.0**；主 bin **`xrkh`**，亦 **`xrk-harness`**） |
...
[Getting started](./docs/getting-started.md) · [Configuration](./docs/configuration.md) · [Status](./docs/status.md) · [Docs hub](./docs/README.md) · [v0.3.0 release notes](./docs/releases/v0.3.0.md)
...
| Public CLI package `@xrkseek/harness-cli` | **Working** (**v0.3.0**; primary bin **`xrkh`**, also **`xrk-harness`**) |
