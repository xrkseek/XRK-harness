...
[入门](./docs/getting-started.md) · [配置](./docs/configuration.md) · [能力矩阵](./docs/status.md) · [文档中心](./docs/README.md) · [v0.1.24 发行说明](./docs/releases/v0.1.24.md)
...
| 对外 CLI 包 `@xrkseek/harness-cli` | **能跑**（**v0.1.24**；主 bin **`xrkh`**，亦 **`xrk-harness`**） |
...
| 版本发行说明 | [releases](./docs/releases/)（正式 [v0.1.24](./docs/releases/v0.1.24.md) · 预览 [v0.0.11](./docs/releases/v0.0.11.md)） |
...
[Getting started](./docs/getting-started.md) · [Configuration](./docs/configuration.md) · [Status](./docs/status.md) · [Docs hub](./docs/README.md) · [v0.1.24 release notes](./docs/releases/v0.1.24.md)
...
| Public CLI package `@xrkseek/harness-cli` | **Working** (**v0.1.24**; primary bin **`xrkh`**, also **`xrk-harness`**) |
...
| Release notes | [releases](./docs/releases/) (formal [v0.1.24](./docs/releases/v0.1.24.md) · preview [v0.0.11](./docs/releases/v0.0.11.md)) |
